...
=head2 Set up
	...
	suvelan parameter values

=cut

	$suvelan				->clear();
	$suvelan				->anis1(quotemeta(0.0));
	$suvelan				->anis2(quotemeta(0));
	$suvelan				->dtratio(quotemeta(5));
	$suvelan				->dv(quotemeta(50.0));
	$suvelan				->fv(quotemeta(1500.0));
	$suvelan				->nv(quotemeta(50));
	$suvelan				->pwr(quotemeta(1.0));
	$suvelan				->smute(quotemeta(1.5));
	$suvelan				->verbose(quotemeta(0));
