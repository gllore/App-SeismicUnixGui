...
=cut
 	 ...
 	 $suximage 	 	 	 	 ->clear();
 	 $suximage 	 	 	 	 ->curve(quotemeta($DATA_SEISMIC_TXT.'/curve1'.','.$DATA_SEISMIC_TXT.'/'.'curve2'));
 	 $suximage 	 	 	 	 ->curvecolor(quotemeta('green,blue'));
 	 $suximage 	 	 	 	 ->curvewidth(quotemeta('1,1'));
 	 $suximage 	 	 	 	 ->npair(quotemeta('3,3'));
