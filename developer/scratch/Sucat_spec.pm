package Sucat_spec;
	...
	_binding_index_aref	    => '',
	_suffix_type_in			=> $su,  			#default
	_data_suffix_in			=> $suffix_su, 		#default
	_suffix_type_out			=> $su,	 			#default
...
=cut
 ...
 sub get_binding_index_aref{
	...
	if ($Sucat_spec->{_binding_index_aref} ) {
		...
		print("Sucat_spec, get_binding_index_aref, missing binding_index_aref\n");
		return();
	}
...
=cut 
 ...
 sub get_file_dialog_type_aref{
	...
	if ( $Sucat_spec->{_file_dialog_type_aref}) {
		...
		print("Sucat_spec,get_file_dialog_type_aref, missing file_dialog_type_aref\n");
		return();
	}
 }
