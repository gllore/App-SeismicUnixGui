...
=cut
 ...
 sub get_binding_index_aref{
	...
	if ($suop_spec->{_binding_index_aref} ) {
		...
		print("suop_spec, get_binding_index_aref, missing binding_index_aref\n");
		return();
	}
...
=cut
 ...
 sub get_binding_length{
	...
	if ($suop_spec->{_binding_index_aref} ) {
		...
		my $binding_length= scalar @{$suop_spec->{_binding_index_aref}};
...
=cut
 ...
 sub get_file_dialog_type_aref{
	...
	if ($suop_spec->{_file_dialog_type_aref} ) {
		...
		print("suop_spec, get_file_dialog_type_aref, missing get_file_dialog_type_aref\n");
		return();
	}
