...
=cut
 ...
 sub angmax {
	...
	if ( $angmax ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' angmax='.$sudatumk2dr->{_angmax};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' angmax='.$sudatumk2dr->{_angmax};
...
=cut
 ...
 sub antiali {
	...
	if ( $antiali ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' antiali='.$sudatumk2dr->{_antiali};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' antiali='.$sudatumk2dr->{_antiali};
...
=cut
 ...
 sub aperx {
	...
	if ( $aperx ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' aperx='.$sudatumk2dr->{_aperx};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' aperx='.$sudatumk2dr->{_aperx};
...
=cut
 ...
 sub ds {
	...
	if ( $ds ne $empty_string ) {
		...
		$sudatumk2dr->{_ds}		= $ds;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' ds='.$sudatumk2dr->{_ds};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' ds='.$sudatumk2dr->{_ds};
...
=cut
 ...
 sub dt {
	...
	if ( $dt ne $empty_string ) {
		...
		$sudatumk2dr->{_dt}		= $dt;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dt='.$sudatumk2dr->{_dt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dt='.$sudatumk2dr->{_dt};
...
=cut
 ...
 sub dvz {
	...
	if ( $dvz ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dvz='.$sudatumk2dr->{_dvz};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dvz='.$sudatumk2dr->{_dvz};
...
=cut
 ...
 sub dxgo {
	...
	if ( $dxgo ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dxgo='.$sudatumk2dr->{_dxgo};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dxgo='.$sudatumk2dr->{_dxgo};
...
=cut
 ...
 sub dxi {
	...
	if ( $dxi ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dxi='.$sudatumk2dr->{_dxi};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dxi='.$sudatumk2dr->{_dxi};
...
=cut
 ...
 sub dxso {
	...
	if ( $dxso ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dxso='.$sudatumk2dr->{_dxso};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dxso='.$sudatumk2dr->{_dxso};
...
=cut
 ...
 sub dxt {
	...
	if ( $dxt ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dxt='.$sudatumk2dr->{_dxt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dxt='.$sudatumk2dr->{_dxt};
...
=cut
 ...
 sub dzo {
	...
	if ( $dzo ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dzo='.$sudatumk2dr->{_dzo};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dzo='.$sudatumk2dr->{_dzo};
...
=cut
 ...
 sub dzt {
	...
	if ( $dzt ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' dzt='.$sudatumk2dr->{_dzt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' dzt='.$sudatumk2dr->{_dzt};
...
=cut
 ...
 sub fmax {
	...
	if ( $fmax ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fmax='.$sudatumk2dr->{_fmax};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fmax='.$sudatumk2dr->{_fmax};
...
=cut
 ...
 sub fs {
	...
	if ( $fs ne $empty_string ) {
		...
		$sudatumk2dr->{_fs}		= $fs;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fs='.$sudatumk2dr->{_fs};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fs='.$sudatumk2dr->{_fs};
...
=cut
 ...
 sub ft {
	...
	if ( $ft ne $empty_string ) {
		...
		$sudatumk2dr->{_ft}		= $ft;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' ft='.$sudatumk2dr->{_ft};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' ft='.$sudatumk2dr->{_ft};
...
=cut
 ...
 sub fxgo {
	...
	if ( $fxgo ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fxgo='.$sudatumk2dr->{_fxgo};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fxgo='.$sudatumk2dr->{_fxgo};
...
=cut
 ...
 sub fxi {
	...
	if ( $fxi ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fxi='.$sudatumk2dr->{_fxi};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fxi='.$sudatumk2dr->{_fxi};
...
=cut
 ...
 sub fxso {
	...
	if ( $fxso ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fxso='.$sudatumk2dr->{_fxso};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fxso='.$sudatumk2dr->{_fxso};
...
=cut
 ...
 sub fxt {
	...
	if ( $fxt ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fxt='.$sudatumk2dr->{_fxt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fxt='.$sudatumk2dr->{_fxt};
...
=cut
 ...
 sub fzo {
	...
	if ( $fzo ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fzo='.$sudatumk2dr->{_fzo};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fzo='.$sudatumk2dr->{_fzo};
...
=cut
 ...
 sub fzt {
	...
	if ( $fzt ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' fzt='.$sudatumk2dr->{_fzt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' fzt='.$sudatumk2dr->{_fzt};
...
=cut
 ...
 sub infile {
	...
	if ( $infile ne $empty_string ) {
		...
		$sudatumk2dr->{_infile}		= $infile;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' infile='.$sudatumk2dr->{_infile};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' infile='.$sudatumk2dr->{_infile};

	} else { 
		print("sudatumk2dr, infile, missing infile,\n");
	 }
 }
...
=cut
 ...
 sub jpfile {
	...
	if ( $jpfile ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' jpfile='.$sudatumk2dr->{_jpfile};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' jpfile='.$sudatumk2dr->{_jpfile};
...
=cut
 ...
 sub mtr {
	...
	if ( $mtr ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' mtr='.$sudatumk2dr->{_mtr};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' mtr='.$sudatumk2dr->{_mtr};
...
=cut
 ...
 sub ns {
	...
	if ( $ns ne $empty_string ) {
		...
		$sudatumk2dr->{_ns}		= $ns;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' ns='.$sudatumk2dr->{_ns};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' ns='.$sudatumk2dr->{_ns};
...
=cut
 ...
 sub ntr {
	...
	if ( $ntr ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' ntr='.$sudatumk2dr->{_ntr};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' ntr='.$sudatumk2dr->{_ntr};
...
=cut
 ...
 sub nxgo {
	...
	if ( $nxgo ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' nxgo='.$sudatumk2dr->{_nxgo};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' nxgo='.$sudatumk2dr->{_nxgo};
...
=cut
 ...
 sub nxi {
	...
	if ( $nxi ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' nxi='.$sudatumk2dr->{_nxi};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' nxi='.$sudatumk2dr->{_nxi};
...
=cut
 ...
 sub nxso {
	...
	if ( $nxso ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' nxso='.$sudatumk2dr->{_nxso};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' nxso='.$sudatumk2dr->{_nxso};
...
=cut
 ...
 sub nxt {
	...
	if ( $nxt ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' nxt='.$sudatumk2dr->{_nxt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' nxt='.$sudatumk2dr->{_nxt};
...
=cut
 ...
 sub nzo {
	...
	if ( $nzo ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' nzo='.$sudatumk2dr->{_nzo};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' nzo='.$sudatumk2dr->{_nzo};
...
=cut
 ...
 sub nzt {
	...
	if ( $nzt ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' nzt='.$sudatumk2dr->{_nzt};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' nzt='.$sudatumk2dr->{_nzt};
...
=cut
 ...
 sub offmax {
	...
	if ( $offmax ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' offmax='.$sudatumk2dr->{_offmax};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' offmax='.$sudatumk2dr->{_offmax};
...
=cut
 ...
 sub outfile {
	...
	if ( $outfile ne $empty_string ) {
		...
		$sudatumk2dr->{_outfile}		= $outfile;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' outfile='.$sudatumk2dr->{_outfile};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' outfile='.$sudatumk2dr->{_outfile};

	} else { 
		print("sudatumk2dr, outfile, missing outfile,\n");
	 }
 }
...
=cut
 ...
 sub sgn {
	...
	if ( $sgn ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' sgn='.$sudatumk2dr->{_sgn};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' sgn='.$sudatumk2dr->{_sgn};
...
=cut
 ...
 sub surf {
	...
	if ( $surf ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' surf='.$sudatumk2dr->{_surf};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' surf='.$sudatumk2dr->{_surf};
...
=cut
 ...
 sub ttfile {
	...
	if ( $ttfile ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' ttfile='.$sudatumk2dr->{_ttfile};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' ttfile='.$sudatumk2dr->{_ttfile};
...
=cut
 ...
 sub v0 {
	...
	if ( $v0 ne $empty_string ) {
		...
		$sudatumk2dr->{_v0}		= $v0;
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' v0='.$sudatumk2dr->{_v0};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' v0='.$sudatumk2dr->{_v0};
...
=cut
 ...
 sub verbose {
	...
	if ( $verbose ne $empty_string ) {
		...
		$sudatumk2dr->{_note}		= $sudatumk2dr->{_note}.' verbose='.$sudatumk2dr->{_verbose};
		$sudatumk2dr->{_Step}		= $sudatumk2dr->{_Step}.' verbose='.$sudatumk2dr->{_verbose};
