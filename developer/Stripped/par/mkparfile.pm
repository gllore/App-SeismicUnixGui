...
=cut
 ...
 sub string1 {
	...
	if ( $string1 ne $empty_string ) {
		...
		$mkparfile->{_note}		= $mkparfile->{_note}.' string1='.$mkparfile->{_string1};
		$mkparfile->{_Step}		= $mkparfile->{_Step}.' string1='.$mkparfile->{_string1};
...
=cut
 ...
 sub string2 {
	...
	if ( $string2 ne $empty_string ) {
		...
		$mkparfile->{_note}		= $mkparfile->{_note}.' string2='.$mkparfile->{_string2};
		$mkparfile->{_Step}		= $mkparfile->{_Step}.' string2='.$mkparfile->{_string2};
...
=cut
 ...
 sub tnmo {
	...
	if ( $tnmo ne $empty_string ) {
		...
		$mkparfile->{_note}		= $mkparfile->{_note}.' tnmo='.$mkparfile->{_tnmo};
		$mkparfile->{_Step}		= $mkparfile->{_Step}.' tnmo='.$mkparfile->{_tnmo};
...
=cut
 ...
 sub vnmo {
	...
	if ( $vnmo ne $empty_string ) {
		...
		$mkparfile->{_note}		= $mkparfile->{_note}.' vnmo='.$mkparfile->{_vnmo};
		$mkparfile->{_Step}		= $mkparfile->{_Step}.' vnmo='.$mkparfile->{_vnmo};
