...
=cut
 ...
 sub dlens {
	...
	if ( $dlens ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' dlens='.$makevel->{_dlens};
		$makevel->{_Step}		= $makevel->{_Step}.' dlens='.$makevel->{_dlens};
...
=cut
 ...
 sub tlens {
	...
	if ( $tlens ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' tlens='.$makevel->{_tlens};
		$makevel->{_Step}		= $makevel->{_Step}.' tlens='.$makevel->{_tlens};
...
=cut
 ...
 sub vlens {
	...
	if ( $vlens ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' vlens='.$makevel->{_vlens};
		$makevel->{_Step}		= $makevel->{_Step}.' vlens='.$makevel->{_vlens};
...
=cut
 ...
 sub vzfile {
	...
	if ( $vzfile ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' vzfile='.$makevel->{_vzfile};
		$makevel->{_Step}		= $makevel->{_Step}.' vzfile='.$makevel->{_vzfile};
...
=cut
 ...
 sub vzran {
	...
	if ( $vzran ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' vzran='.$makevel->{_vzran};
		$makevel->{_Step}		= $makevel->{_Step}.' vzran='.$makevel->{_vzran};
...
=cut
 ...
 sub xlens {
	...
	if ( $xlens ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' xlens='.$makevel->{_xlens};
		$makevel->{_Step}		= $makevel->{_Step}.' xlens='.$makevel->{_xlens};
...
=cut
 ...
 sub ylens {
	...
	if ( $ylens ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' ylens='.$makevel->{_ylens};
		$makevel->{_Step}		= $makevel->{_Step}.' ylens='.$makevel->{_ylens};
...
=cut
 ...
 sub zlens {
	...
	if ( $zlens ne $empty_string ) {
		...
		$makevel->{_note}		= $makevel->{_note}.' zlens='.$makevel->{_zlens};
		$makevel->{_Step}		= $makevel->{_Step}.' zlens='.$makevel->{_zlens};
