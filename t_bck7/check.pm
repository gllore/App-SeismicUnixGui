...
sub _get_instructions {
	...
	#    $instruction[2] = (" sudo --user=$username --login perl $PL_SEISMIC/Suclean_geom.pl ");
	#    $instruction[3] = (" sudo --user=$username --login perl $PL_SEISMIC/SuGeom2.pl ");
	#    $instruction[4] = (" sudo --user=$username --login perl $PL_SEISMIC/SuGeom3.pl ");
	#    $instruction[4] = (" sudo --user=$username --login perl $PL_SEISMIC/view_L28Hz_Ibeam.pl");
	#    $instruction[4] = (" sudo --user=$username --login perl $PL_SEISMIC/SuPlotHeader.pl");
