...
my $superflow_sub_ref
  ;    # $superflow->{_sub_ref} does not transfer in namespace between subs
...
sub get_hash_ref {
    ...
    if ($superflow) {
        ...
        $superflow->{_check_buttons_settings_aref} =
        ...
        $superflow->{_flow_item_down_arrow_button} =
          $flow_item_down_arrow_button;
        $superflow->{_flow_item_up_arrow_button} =
          $flow_item_up_arrow_button;                                        #20
        ...
        $superflow->{_has_used_check_code_button} =
          $has_used_check_code_button;                                       #30
        ...
        $superflow->{_has_used_open_perl_file_button} =
        ...
        $superflow->{_is_flow_item_up_arrow_button} =
          $is_flow_item_up_arrow_button;
        $superflow->{_is_flow_item_down_arrow_button} =
        ...
        $superflow->{_is_last_flow_index_touched_grey} =
          $is_last_flow_index_touched_grey;
        $superflow->{_is_last_flow_index_touched_pink} =
          $is_last_flow_index_touched_pink;
        $superflow->{_is_last_flow_index_touched_green} =
          $is_last_flow_index_touched_green;
        $superflow->{_is_last_flow_index_touched_blue} =
          $is_last_flow_index_touched_blue;
        $superflow->{_is_last_parameter_index_touched_grey} =
          $is_last_parameter_index_touched_grey;
        $superflow->{_is_last_parameter_index_touched_pink} =
          $is_last_parameter_index_touched_pink;
        $superflow->{_is_last_parameter_index_touched_green} =
          $is_last_parameter_index_touched_green;
        $superflow->{_is_last_parameter_index_touched_blue} =
          $is_last_parameter_index_touched_blue;
        $superflow->{_is_last_flow_index_touched} = $is_last_flow_index_touched;
        $superflow->{_is_last_parameter_index_touched} =
          $is_last_parameter_index_touched;    #46
        ...
        $superflow->{_is_superflow_select_button} =
          $is_superflow_select_button;                                       #58
        $superflow->{_is_user_built_flow} = $is_user_built_flow;             #59
        $superflow->{_labels_w_aref}      = $labels_w_aref;                  #60
        $superflow->{_last_flow_index_touched_grey} =
          $last_flow_index_touched_grey;                                     #61
        $superflow->{_last_flow_index_touched_pink} =
          $last_flow_index_touched_pink;                                     #61
        $superflow->{_last_flow_index_touched_green} =
          $last_flow_index_touched_green;                                    #61
        $superflow->{_last_flow_index_touched_blue} =
          $last_flow_index_touched_blue;                                     #61
        $superflow->{_last_flow_index_touched} = $last_flow_index_touched;   #61
        $superflow->{_last_flow_listbox_touched} =
          $last_flow_listbox_touched;                                        #62
        $superflow->{_last_flow_listbox_touched_w} =
          $last_flow_listbox_touched_w;                                      #63
        $superflow->{_last_parameter_index_touched_grey} =
          $last_parameter_index_touched_grey;                                #64
        $superflow->{_last_parameter_index_touched_pink} =
          $last_parameter_index_touched_pink;                                #64
        $superflow->{_last_parameter_index_touched_green} =
          $last_parameter_index_touched_green;                               #64
        $superflow->{_last_parameter_index_touched_blue} =
          $last_parameter_index_touched_blue;                                #64
        $superflow->{_last_parameter_index_touched} =
          $last_parameter_index_touched;                                     #64
...
sub set_flowNsuperflow_name_w {
    ...
    if ($flowNsuperflow_name_w) {
        ...
        if ( $superflow->{_prog_name_sref} ) {    # previously loaded
            ...
            print(
"pre_built_superflow, set_flowNsuperflow_name_w, missing widget name\n"
            );
        }
        ...
        print(
"pre_built_superflow, set_flowNsuperflow_name_w, missing program name\n"
        );
    }
...
sub set_hash_ref {
    ...
    $is_last_parameter_index_touched =
      $hash_ref->{_is_last_parameter_index_touched};    #46
    ...
    $last_parameter_index_touched_grey =
      $hash_ref->{_last_parameter_index_touched_grey};                       #64
    $last_parameter_index_touched_pink =
      $hash_ref->{_last_parameter_index_touched_pink};                       #64
    $last_parameter_index_touched_green =
      $hash_ref->{_last_parameter_index_touched_green};                      #64
    $last_parameter_index_touched_blue =
      $hash_ref->{_last_parameter_index_touched_blue};                       #64
    $last_parameter_index_touched =
      $hash_ref->{_last_parameter_index_touched};                            #64
    ...
    $superflow->{_is_delete_from_flow_button} =
    ...
    $superflow->{_is_flow_item_down_arrow_button} =
      $hash_ref->{_is_flow_item_down_arrow_button};
    $superflow->{_is_flow_listbox_grey_w} =
      $hash_ref->{_is_flow_listbox_grey_w};
    $superflow->{_is_flow_listbox_pink_w} =
      $hash_ref->{_is_flow_listbox_pink_w};
    $superflow->{_is_flow_listbox_green_w} =
      $hash_ref->{_is_flow_listbox_green_w};
    $superflow->{_is_flow_listbox_blue_w} =
      $hash_ref->{_is_flow_listbox_blue_w};
    $superflow->{_is_flow_listbox_color_w} =
      $hash_ref->{_is_flow_listbox_color_w};    #44
    $superflow->{_is_last_flow_index_touched_grey} =
      $hash_ref->{_is_last_flow_index_touched_grey};
    $superflow->{_is_last_flow_index_touched_pink} =
      $hash_ref->{_is_last_flow_index_touched_pink};
    ...
    $superflow->{_last_flow_index_touched} =
      $hash_ref->{_last_flow_index_touched};
    $superflow->{_last_flow_listbox_touched} =
      $hash_ref->{_last_flow_listbox_touched};
    $superflow->{_last_flow_listbox_touched_w} =
      $hash_ref->{_last_flow_listbox_touched_w};
    $superflow->{_last_parameter_index_touched_grey} =
    ...
    $superflow->{_last_parameter_index_touched} =
      $hash_ref->{_last_parameter_index_touched};
...
sub set_gui_widgets {
    ...
    if ($widget_hash_ref) {
        ...
        $superflow->{_flow_listbox_grey_w} =
          $widget_hash_ref->{_flow_listbox_grey_w};
        $superflow->{_flow_listbox_pink_w} =
          $widget_hash_ref->{_flow_listbox_pink_w};
        $superflow->{_flow_listbox_green_w} =
          $widget_hash_ref->{_flow_listbox_green_w};
        $superflow->{_flow_listbox_blue_w} =
          $widget_hash_ref->{_flow_listbox_blue_w};
        $superflow->{_flow_listbox_color_w} =
        ...
        $superflow->{_parameter_values_frame} =
