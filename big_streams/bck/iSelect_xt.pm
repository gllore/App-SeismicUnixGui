...
=cut
        ...
        and $iSelect_xt->{_purpose} ne $empty_string )
    {
            ...
            && $iSelect_xt->{_error_freq} eq $true )
        {
            ...
            # print("1. iSelect_xt, purpose:$iSelect_xt->{_purpose}\n");
            # print("1. iSelect_xt, _error: \$iSelect_xt->{_error_freq}n");
            # print("1. iSelect_xt, unconstrained purpose\n");
        }
      ...
      )
    {
        ...
        # print("1. iSelect_xt, purpose:---$iSelect_xt->{_purpose}---\n");
        # print("1. iSelect_xt, error_freq:---$iSelect_xt->{_error_freq}---\n");
        # print("1. iSelect_xt, unexpected purpose\n");
    }
