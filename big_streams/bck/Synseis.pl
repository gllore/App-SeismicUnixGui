...
=cut 
 	...
 	my ($DATA_RESISTIVITY_WELL_TXT) = $Project->DATA_RESISTIVITY_WELL_TXT();  # from False River
...
=cut
  ...
  $a2b  			-> outpar(quotemeta($DATA_SEISMIC_WELL_SYNSEIS.'/'.'.temp_zrho_reg'));
  $a2b[1]  			= $a2b->Step();
...
=cut
  ...
  $a2b				-> clear();
  $a2b  			-> floats_per_line(quotemeta(2));
  $a2b  			-> outpar(quotemeta($DATA_SEISMIC_WELL_SYNSEIS.'/'.'.temp_zv_reg'));
  $a2b[2]  			=  $a2b->Step();
...
=cut
  ...
  $a2b				-> clear();
  $a2b  			-> floats_per_line(quotemeta(2));
  $a2b  			-> outpar(quotemeta($DATA_SEISMIC_WELL_SYNSEIS.'/'.'.temp_reflection_coef_depth'));
  $a2b[3]  			=  $a2b->Step();
...
=cut
  ...
  $a2b				-> clear();
  $a2b  			-> floats_per_line(quotemeta(2));
  $a2b  			-> outpar(quotemeta($DATA_SEISMIC_WELL_SYNSEIS.'/'.'.temp_reflection_coef_time'));
  $a2b[4]  			=  $a2b->Step();
...
=cut
  ...
  $a2b				-> clear();
  $a2b  			-> floats_per_line(quotemeta(2));
  $a2b  			-> outpar(quotemeta($DATA_SEISMIC_WELL_SYNSEIS.'/'.'.temp_output_synthetic_seismogram'));
  $a2b[5]  			=  $a2b->Step();
...
=cut
 ...
 $Synseis     		-> time_sampling_interval(quotemeta($time_sampling_interval_s)); # seconds
 $Synseis     		-> depth_sampling_interval(quotemeta($depth_sampling_interval_m)); # meters
 ...
 $Synseis     		-> Ricker_file(quotemeta($DATA_SEISMIC_WELL_SYNSEIS.'/'.'ricker.out'));
