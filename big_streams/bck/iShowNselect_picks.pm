...
=cut
    ...
    my $wagc =
      ( $iShowNselect_picks->{_max_time_s} -
          $iShowNselect_picks->{_min_time_s} ) / 10;
        ...
        and $iShowNselect_picks->{_purpose} ne $empty_string )
    {
            ...
            && $iShowNselect_picks->{_error_freq} eq $true )
        {
            ...
            @items = (
                ...
                $to, $suwind[2], $to, $sugain[1], $to, $suxwigb[1], $go
            );
            ...
            @items = (
                $suwind[1], $in, $iShowNselect_picks->{_inbound},
                $to, $suwind[2], $to, $sugain[1], $to, $suximage[1], $go
            );
...
# print("1. iShowNselect_picks, unconstrained purpose\n");
      ...
      )
    {
        ...
        @items = (
            $suwind[1], $in, $iShowNselect_picks->{_inbound},
            $to, $suwind[2], $to, $sufilter[1], $to, $sugain[1], $to,
            $suxwigb[1], $go
        );
        $flow[1] = $run->modules( \@items );
