		...
		if ( -e $inbound ) {
			...
			for ( my $layer_index = 0; $layer_index < $number_of_layers; $layer_index++ ) {
				...
				if ( $error_switch eq $on ) {
					...
					#				print("immodpg,_get_model, MODEL OK in layer=$layer_index; NADA\n");
			...
			print("immodpg,_get_model,fiel is missing\n");
		} else {
			print("immodpg,_get_model,unexpected value\n");
		}
...
#			if ( $error_switch eq $on ) {
#
#				print("immodpg,get_model, CORRUPT MODEL\n");
#
#			} elsif ( $error_switch eq $off ) {
#
#				print("immodpg,get_model, MODEL OK\n");
#			} else {
#				print("immodpg,get_model, unexpected value\n");
#			}
#		}
#
#			#			print("VPtop = $VPtop[$layer_index], VPbot=$VPbot[$layer_index],layer_index=$layer_index\n");
