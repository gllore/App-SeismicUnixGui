...
=cut
 	 ...
 	 $data_in 	 	 	 	 ->clear();
 	 $data_in 	 	 	 	 ->base_file_name(quotemeta('hseis'));
...
=cut
 	 ...
 	 $suxwigb 	 	 	 	 ->box_X0(quotemeta(510));
 	 $suxwigb 	 	 	 	 ->box_Y0(quotemeta(50));
 	 $suxwigb 	 	 	 	 ->orientation(quotemeta('seismic'));
 	 $suxwigb 	 	 	 	 ->title(quotemeta('Horizontal line of seismograms'));
 	 $suxwigb 	 	 	 	 ->windowtitle(quotemeta('Horizontal'));
 	 $suxwigb 	 	 	 	 ->xlabel(quotemeta('Distance (km)'));
