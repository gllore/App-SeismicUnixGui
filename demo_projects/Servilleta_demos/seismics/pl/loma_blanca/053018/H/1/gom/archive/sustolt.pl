...
=cut
	...
	$sustolt				->cdpmin(quotemeta(1));
	$sustolt				->dxcdp(quotemeta(1));
	$sustolt				->lbtaper(quotemeta(0));
	$sustolt				->lstaper(quotemeta(0));
	$sustolt				->noffmix(quotemeta(1));
	$sustolt				->smig(quotemeta(1.0));
	$sustolt				->tmig(quotemeta('0.0,1.'));
	$sustolt				->tmpdir(quotemeta('./'));
	$sustolt				->verbose(quotemeta(0));
	$sustolt				->vmig(quotemeta('100,500.0'));
	$sustolt				->vscale(quotemeta(1.0));
...
=cut
	...
	$suximage				->windowtitle(quotemeta('poopsa'));
