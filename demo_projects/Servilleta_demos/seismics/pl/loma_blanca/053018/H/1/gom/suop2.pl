...
=cut
 	 ...
 	 $sushw 	 	 	 	 ->clear();
 	 $sushw 	 	 	 	 ->first_value(quotemeta('0,1'));
 	 $sushw 	 	 	 	 ->gather_size(quotemeta('60,60'));
 	 $sushw 	 	 	 	 ->headerwords(quotemeta('sx,gx'));
 	 $sushw 	 	 	 	 ->intra_gather_inc(quotemeta('0,1'));
 	 $sushw 	 	 	 	 ->inter_gather_inc(quotemeta('1,0'));
 	 $sushw [1]  	 	 	 = $sushw ->Step();
...
=cut
 	 ...
 	 $data_out 	 	 	 	 ->clear();
 	 $data_out 	 	 	 	 ->base_file_name(quotemeta('L28Hz_Ibeam_geom2'));
