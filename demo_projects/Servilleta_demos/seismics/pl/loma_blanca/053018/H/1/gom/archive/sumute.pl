...
# if using only one shot gather at a time uncomment the following 3 lines
#  $gatherNumber[1]           = 142;
#  $min_gatherNumber[1]       = $gatherNumber[1];
#  $max_gatherNumber[1]       = $gatherNumber[1];

# if using only many shot gathers at a time uncomment the following 3 lines
  $min_gatherNumber[1]       = 1;
  $max_gatherNumber[1]       = 142;
  $top_mute_list             = 'top_mute_list2'; 
