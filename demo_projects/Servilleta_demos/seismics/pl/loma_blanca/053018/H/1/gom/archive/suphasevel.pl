...
=cut
	...
	$suphasevel				->clear();
	$suphasevel				->dv(quotemeta(5));
	$suphasevel				->fmax(quotemeta(100));
	$suphasevel				->fv(quotemeta(50));
	$suphasevel				->norm(quotemeta(1));
	$suphasevel				->nv(quotemeta(150));
	$suphasevel				->verbose(quotemeta(1));
...
=cut
	...
	$suximage				->hiclip(quotemeta(100));
	$suximage				->cmap(quotemeta('hsv6'));
	$suximage				->dt(quotemeta(1));
	$suximage				->dx(quotemeta(1));
	$suximage				->first_distance_sample_value(quotemeta(50));
	...
	$suximage				->windowtitle(quotemeta('Dispersion Analysis-2018'));
