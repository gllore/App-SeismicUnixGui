...
my @sunix_filter_programs = ( "sufilter", "sudipfilt", "sugrbfb", );
...
my @sunix_inversion_programs = ( "supef", );

my @sunix_migration_programs = ( "sustolt", );
my @sunix_misc_programs      = ();

my @sunix_model_programs = ( "suplane", "susynlv", "unif2", "suea2df" );

my @sunix_NMO_Vel_Stk_programs = ( "sunmo", "sustack", "suttoz", "suvelan", );

my @sunix_par_programs = ( "a2b", "b2a", "mkparfile", "makevel", );
...
my @sunix_plot_programs =
  ( "suximage", "suxgraph", "suxwigb", "xgraph", "ximage", "xwigb", );

my @sunix_shapeNcut_programs = ( "sumute", "sugain", "susort", "suwind", );
...
my @sunix_transform_programs = (
    ...
    "supef",  "suphasevel",  "suspecfk",   "suspecfx",
    "sutaup",
);
...
$var->{_sunix_misc_programs}        = \@sunix_misc_programs;
