...
sub ntr {
    ...
    if ( $nplot ne $empty_string ) {
        ...
        print("suxgraph, ntr, missing ntr,\n");
    }
}
...
sub first_time_tick_num {
    ...
    if ( $f1 ne $empty_string ) {
        ...
        print("suxgraph, first_time_tick_num, missing f1,\n");
    }
}
...
sub geometry {
    ...
    if ($geometry) {
        ...
        $suxgraph->{_note} =
          $suxgraph->{_note} . ' -geom ' . $suxgraph->{_geometry};
        $suxgraph->{_Step} =
          $suxgraph->{_Step} . ' -geom ' . $suxgraph->{_geometry};
...
sub xgrid_lines {
    ...
    if ($grid2) {
        ...
        print("suxgraph, xgrid_lines, missing grid2,\n");
    }
}
...
sub xstart_m {
    ...
    if ( $x2beg ne $empty_string ) {
        ...
        print("suxgraph, xstart_m, missing x2beg,\n");
    }
}
...
sub y_label {
    ...
    if ($label2) {
        ...
        print("suxgraph, y_label, missing y_label,\n");
    }
}

=head2 sub ygrid_lines 
...
sub ygrid_lines {
    ...
    if ($grid1) {
        ...
        print("suxgraph, ygrid_lines, missing grid1,\n");
    }
}
...
sub ylabel {
    ...
    my ( $self, $ylabel ) = @_;
    if ( $ylabel ne $empty_string ) {

        $suxgraph->{_label1} = $ylabel;
        $suxgraph->{_note} =
          $suxgraph->{_note} . ' label1=' . $suxgraph->{_label1};
        $suxgraph->{_Step} =
          $suxgraph->{_Step} . ' label1=' . $suxgraph->{_label1};
        ...
        print("suxgraph, ylabel, missing label1,\n");
    }
}
...
sub ystart_s {
    ...
    if ( $x1beg ne $empty_string ) {
        ...
        print("suxgraph, ystart_s, missing x1beg,\n");
    }
}
