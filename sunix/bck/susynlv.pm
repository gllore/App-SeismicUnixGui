...
=head2 SYNOPSIS
 ...
 PACKAGE NAME:  SUSYNLV - SYNthetic seismograms for Linear Velocity function		
 AUTHOR: Juan Lorenzo
 DATE:   
 DESCRIPTION:
 Version: 
...
sub fpeak {
    ...
    if ( $fpeak ne $empty_string ) {
        ...
        $susynlv->{_note} =
          $susynlv->{_note} . ' fpeak=' . $susynlv->{_fpeak};
        $susynlv->{_Step} =
          $susynlv->{_Step} . ' fpeak=' . $susynlv->{_fpeak};
...
sub kilounits {
    ...
    if ( $kilounits ne $empty_string ) {
        ...
        $susynlv->{_note} =
          $susynlv->{_note} . ' kilounits=' . $susynlv->{_kilounits};
        $susynlv->{_Step} =
          $susynlv->{_Step} . ' kilounits=' . $susynlv->{_kilounits};
...
sub ndpfz {
    ...
    if ( $ndpfz ne $empty_string ) {
        ...
        $susynlv->{_note} =
          $susynlv->{_note} . ' ndpfz=' . $susynlv->{_ndpfz};
        $susynlv->{_Step} =
          $susynlv->{_Step} . ' ndpfz=' . $susynlv->{_ndpfz};
...
sub reflector {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_12, missing ref,\n");
    }
}

=head2 sub reflector_2 
...
sub reflector_2 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_2, missing ref,\n");
    }
}

=head2 sub reflector_3 
...
sub reflector_3 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_3, missing ref,\n");
    }
}

=head2 sub reflector_4 
...
sub reflector_4 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_4, missing ref,\n");
    }
}

=head2 sub reflector_5 
...
sub reflector_5 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_5, missing ref,\n");
    }
}

=head2 sub reflector_6 
...
sub reflector_6 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_6, missing ref,\n");
    }
}

=head2 sub reflector_7 
...
sub reflector_7 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_7, missing ref,\n");
    }
}

=head2 sub reflector_8 
...
sub reflector_8 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_8, missing ref,\n");
    }
}

=head2 sub reflector_9 
...
sub reflector_9 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_9, missing ref,\n");
    }
}

=head2 sub reflector_10 
...
sub reflector_10 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_10, missing ref,\n");
    }
}

=head2 sub reflector_11 
...
sub reflector_11 {
    ...
    if ( $ref ne $empty_string ) {
        ...
        print("susynlv, reflector_11, missing ref,\n");
    }
}
...
sub smooth {
    ...
    if ( $smooth ne $empty_string ) {
        ...
        $susynlv->{_note} =
          $susynlv->{_note} . ' smooth=' . $susynlv->{_smooth};
        $susynlv->{_Step} =
          $susynlv->{_Step} . ' smooth=' . $susynlv->{_smooth};
...
sub verbose {
    ...
    if ( $verbose ne $empty_string ) {
        ...
        $susynlv->{_note} =
          $susynlv->{_note} . ' verbose=' . $susynlv->{_verbose};
        $susynlv->{_Step} =
          $susynlv->{_Step} . ' verbose=' . $susynlv->{_verbose};
