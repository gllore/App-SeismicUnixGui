...
PACKAGE NAME:  ELAPS - plot a triangulated function p(x,z) via PostScript 		
AUTHOR: Juan Lorenzo
DATE:   
DESCRIPTION:
Version: 
...
=cut
 ...
 sub axescolor {
	...
	if ( $axescolor ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' axescolor='.$elaps->{_axescolor};
		$elaps->{_Step}		= $elaps->{_Step}.' axescolor='.$elaps->{_axescolor};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' gridcolor='.$elaps->{_gridcolor};
		$elaps->{_Step}		= $elaps->{_Step}.' gridcolor='.$elaps->{_gridcolor};
...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' labelfont='.$elaps->{_labelfont};
		$elaps->{_Step}		= $elaps->{_Step}.' labelfont='.$elaps->{_labelfont};
...
=cut
 ...
 sub labelsize {
	...
	if ( $labelsize ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' labelsize='.$elaps->{_labelsize};
		$elaps->{_Step}		= $elaps->{_Step}.' labelsize='.$elaps->{_labelsize};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' titlecolor='.$elaps->{_titlecolor};
		$elaps->{_Step}		= $elaps->{_Step}.' titlecolor='.$elaps->{_titlecolor};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' titlefont='.$elaps->{_titlefont};
		$elaps->{_Step}		= $elaps->{_Step}.' titlefont='.$elaps->{_titlefont};
...
=cut
 ...
 sub titlesize {
	...
	if ( $titlesize ne $empty_string ) {
		...
		$elaps->{_note}		= $elaps->{_note}.' titlesize='.$elaps->{_titlesize};
		$elaps->{_Step}		= $elaps->{_Step}.' titlesize='.$elaps->{_titlesize};
