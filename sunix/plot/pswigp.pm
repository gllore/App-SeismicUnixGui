...
PACKAGE NAME:  PSWIGP - PostScript WIGgle-trace plot of f(x1,x2) via Polygons	
AUTHOR: Juan Lorenzo
DATE:   
DESCRIPTION:
Version: 
...
=cut
 ...
 sub axescolor {
	...
	if ( $axescolor ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' axescolor='.$pswigp->{_axescolor};
		$pswigp->{_Step}		= $pswigp->{_Step}.' axescolor='.$pswigp->{_axescolor};
...
=cut
 ...
 sub axeswidth {
	...
	if ( $axeswidth ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' axeswidth='.$pswigp->{_axeswidth};
		$pswigp->{_Step}		= $pswigp->{_Step}.' axeswidth='.$pswigp->{_axeswidth};
...
=cut
 ...
 sub backcolor {
	...
	if ( $backcolor ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' backcolor='.$pswigp->{_backcolor};
		$pswigp->{_Step}		= $pswigp->{_Step}.' backcolor='.$pswigp->{_backcolor};
...
=cut
 ...
 sub curvecolor {
	...
	if ( $curvecolor ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' curvecolor='.$pswigp->{_curvecolor};
		$pswigp->{_Step}		= $pswigp->{_Step}.' curvecolor='.$pswigp->{_curvecolor};
...
=cut
 ...
 sub curvedash {
	...
	if ( $curvedash ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' curvedash='.$pswigp->{_curvedash};
		$pswigp->{_Step}		= $pswigp->{_Step}.' curvedash='.$pswigp->{_curvedash};
...
=cut
 ...
 sub curvefile {
	...
	if ( $curvefile ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' curvefile='.$pswigp->{_curvefile};
		$pswigp->{_Step}		= $pswigp->{_Step}.' curvefile='.$pswigp->{_curvefile};
...
=cut
 ...
 sub curvewidth {
	...
	if ( $curvewidth ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' curvewidth='.$pswigp->{_curvewidth};
		$pswigp->{_Step}		= $pswigp->{_Step}.' curvewidth='.$pswigp->{_curvewidth};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' gridcolor='.$pswigp->{_gridcolor};
		$pswigp->{_Step}		= $pswigp->{_Step}.' gridcolor='.$pswigp->{_gridcolor};
...
=cut
 ...
 sub gridwidth {
	...
	if ( $gridwidth ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' gridwidth='.$pswigp->{_gridwidth};
		$pswigp->{_Step}		= $pswigp->{_Step}.' gridwidth='.$pswigp->{_gridwidth};
...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' labelfont='.$pswigp->{_labelfont};
		$pswigp->{_Step}		= $pswigp->{_Step}.' labelfont='.$pswigp->{_labelfont};
...
=cut
 ...
 sub labelsize {
	...
	if ( $labelsize ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' labelsize='.$pswigp->{_labelsize};
		$pswigp->{_Step}		= $pswigp->{_Step}.' labelsize='.$pswigp->{_labelsize};
...
=cut
 ...
 sub linewidth {
	...
	if ( $linewidth ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' linewidth='.$pswigp->{_linewidth};
		$pswigp->{_Step}		= $pswigp->{_Step}.' linewidth='.$pswigp->{_linewidth};
...
=cut
 ...
 sub ticwidth {
	...
	if ( $ticwidth ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' ticwidth='.$pswigp->{_ticwidth};
		$pswigp->{_Step}		= $pswigp->{_Step}.' ticwidth='.$pswigp->{_ticwidth};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' titlecolor='.$pswigp->{_titlecolor};
		$pswigp->{_Step}		= $pswigp->{_Step}.' titlecolor='.$pswigp->{_titlecolor};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' titlefont='.$pswigp->{_titlefont};
		$pswigp->{_Step}		= $pswigp->{_Step}.' titlefont='.$pswigp->{_titlefont};
...
=cut
 ...
 sub titlesize {
	...
	if ( $titlesize ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' titlesize='.$pswigp->{_titlesize};
		$pswigp->{_Step}		= $pswigp->{_Step}.' titlesize='.$pswigp->{_titlesize};
...
=cut
 ...
 sub tracecolor {
	...
	if ( $tracecolor ne $empty_string ) {
		...
		$pswigp->{_note}		= $pswigp->{_note}.' tracecolor='.$pswigp->{_tracecolor};
		$pswigp->{_Step}		= $pswigp->{_Step}.' tracecolor='.$pswigp->{_tracecolor};
