...
PACKAGE NAME:  PSCONTOUR - PostScript CONTOURing of a two-dimensional function f(x1,x2)
AUTHOR: Juan Lorenzo
DATE:   
DESCRIPTION:
Version: 
...
=cut
 ...
 sub axescolor {
	...
	if ( $axescolor ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' axescolor='.$pscontour->{_axescolor};
		$pscontour->{_Step}		= $pscontour->{_Step}.' axescolor='.$pscontour->{_axescolor};
...
=cut
 ...
 sub axeswidth {
	...
	if ( $axeswidth ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' axeswidth='.$pscontour->{_axeswidth};
		$pscontour->{_Step}		= $pscontour->{_Step}.' axeswidth='.$pscontour->{_axeswidth};
...
=cut
 ...
 sub ccolor {
	...
	if ( $ccolor ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' ccolor='.$pscontour->{_ccolor};
		$pscontour->{_Step}		= $pscontour->{_Step}.' ccolor='.$pscontour->{_ccolor};
...
=cut
 ...
 sub cdash {
	...
	if ( $cdash ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' cdash='.$pscontour->{_cdash};
		$pscontour->{_Step}		= $pscontour->{_Step}.' cdash='.$pscontour->{_cdash};
...
=cut
 ...
 sub cgray {
	...
	if ( $cgray ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' cgray='.$pscontour->{_cgray};
		$pscontour->{_Step}		= $pscontour->{_Step}.' cgray='.$pscontour->{_cgray};
...
=cut
 ...
 sub cwidth {
	...
	if ( $cwidth ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' cwidth='.$pscontour->{_cwidth};
		$pscontour->{_Step}		= $pscontour->{_Step}.' cwidth='.$pscontour->{_cwidth};
...
=cut
 ...
 sub d1num {
	...
	if ( $d1num ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' d1num='.$pscontour->{_d1num};
		$pscontour->{_Step}		= $pscontour->{_Step}.' d1num='.$pscontour->{_d1num};
...
=cut
 ...
 sub d2num {
	...
	if ( $d2num ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' d2num='.$pscontour->{_d2num};
		$pscontour->{_Step}		= $pscontour->{_Step}.' d2num='.$pscontour->{_d2num};
...
=cut
 ...
 sub f1num {
	...
	if ( $f1num ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' f1num='.$pscontour->{_f1num};
		$pscontour->{_Step}		= $pscontour->{_Step}.' f1num='.$pscontour->{_f1num};
...
=cut
 ...
 sub f2num {
	...
	if ( $f2num ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' f2num='.$pscontour->{_f2num};
		$pscontour->{_Step}		= $pscontour->{_Step}.' f2num='.$pscontour->{_f2num};
...
=cut
 ...
 sub grid1 {
	...
	if ( $grid1 ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' grid1='.$pscontour->{_grid1};
		$pscontour->{_Step}		= $pscontour->{_Step}.' grid1='.$pscontour->{_grid1};
...
=cut
 ...
 sub grid2 {
	...
	if ( $grid2 ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' grid2='.$pscontour->{_grid2};
		$pscontour->{_Step}		= $pscontour->{_Step}.' grid2='.$pscontour->{_grid2};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' gridcolor='.$pscontour->{_gridcolor};
		$pscontour->{_Step}		= $pscontour->{_Step}.' gridcolor='.$pscontour->{_gridcolor};
...
=cut
 ...
 sub gridwidth {
	...
	if ( $gridwidth ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' gridwidth='.$pscontour->{_gridwidth};
		$pscontour->{_Step}		= $pscontour->{_Step}.' gridwidth='.$pscontour->{_gridwidth};
...
=cut
 ...
 sub hbox {
	...
	if ( $hbox ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' hbox='.$pscontour->{_hbox};
		$pscontour->{_Step}		= $pscontour->{_Step}.' hbox='.$pscontour->{_hbox};
...
=cut
 ...
 sub label1 {
	...
	if ( $label1 ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' label1='.$pscontour->{_label1};
		$pscontour->{_Step}		= $pscontour->{_Step}.' label1='.$pscontour->{_label1};
...
=cut
 ...
 sub label2 {
	...
	if ( $label2 ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' label2='.$pscontour->{_label2};
		$pscontour->{_Step}		= $pscontour->{_Step}.' label2='.$pscontour->{_label2};
...
=cut
 ...
 sub labelccolor {
	...
	if ( $labelccolor ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelccolor='.$pscontour->{_labelccolor};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelccolor='.$pscontour->{_labelccolor};
...
=cut
 ...
 sub labelcf {
	...
	if ( $labelcf ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelcf='.$pscontour->{_labelcf};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelcf='.$pscontour->{_labelcf};
...
=cut
 ...
 sub labelcfont {
	...
	if ( $labelcfont ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelcfont='.$pscontour->{_labelcfont};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelcfont='.$pscontour->{_labelcfont};
...
=cut
 ...
 sub labelcper {
	...
	if ( $labelcper ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelcper='.$pscontour->{_labelcper};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelcper='.$pscontour->{_labelcper};
...
=cut
 ...
 sub labelcsize {
	...
	if ( $labelcsize ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelcsize='.$pscontour->{_labelcsize};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelcsize='.$pscontour->{_labelcsize};
...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelfont='.$pscontour->{_labelfont};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelfont='.$pscontour->{_labelfont};
...
=cut
 ...
 sub labelsize {
	...
	if ( $labelsize ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' labelsize='.$pscontour->{_labelsize};
		$pscontour->{_Step}		= $pscontour->{_Step}.' labelsize='.$pscontour->{_labelsize};
...
=cut
 ...
 sub n1tic {
	...
	if ( $n1tic ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' n1tic='.$pscontour->{_n1tic};
		$pscontour->{_Step}		= $pscontour->{_Step}.' n1tic='.$pscontour->{_n1tic};
...
=cut
 ...
 sub n2tic {
	...
	if ( $n2tic ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' n2tic='.$pscontour->{_n2tic};
		$pscontour->{_Step}		= $pscontour->{_Step}.' n2tic='.$pscontour->{_n2tic};
...
=cut
 ...
 sub nlabelc {
	...
	if ( $nlabelc ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' nlabelc='.$pscontour->{_nlabelc};
		$pscontour->{_Step}		= $pscontour->{_Step}.' nlabelc='.$pscontour->{_nlabelc};
...
=cut
 ...
 sub nplaces {
	...
	if ( $nplaces ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' nplaces='.$pscontour->{_nplaces};
		$pscontour->{_Step}		= $pscontour->{_Step}.' nplaces='.$pscontour->{_nplaces};
...
=cut
 ...
 sub style {
	...
	if ( $style ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' style='.$pscontour->{_style};
		$pscontour->{_Step}		= $pscontour->{_Step}.' style='.$pscontour->{_style};
...
=cut
 ...
 sub ticwidth {
	...
	if ( $ticwidth ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' ticwidth='.$pscontour->{_ticwidth};
		$pscontour->{_Step}		= $pscontour->{_Step}.' ticwidth='.$pscontour->{_ticwidth};
...
=cut
 ...
 sub title {
	...
	if ( $title ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' title='.$pscontour->{_title};
		$pscontour->{_Step}		= $pscontour->{_Step}.' title='.$pscontour->{_title};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' titlecolor='.$pscontour->{_titlecolor};
		$pscontour->{_Step}		= $pscontour->{_Step}.' titlecolor='.$pscontour->{_titlecolor};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' titlefont='.$pscontour->{_titlefont};
		$pscontour->{_Step}		= $pscontour->{_Step}.' titlefont='.$pscontour->{_titlefont};
...
=cut
 ...
 sub titlesize {
	...
	if ( $titlesize ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' titlesize='.$pscontour->{_titlesize};
		$pscontour->{_Step}		= $pscontour->{_Step}.' titlesize='.$pscontour->{_titlesize};
...
=cut
 ...
 sub wbox {
	...
	if ( $wbox ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' wbox='.$pscontour->{_wbox};
		$pscontour->{_Step}		= $pscontour->{_Step}.' wbox='.$pscontour->{_wbox};
...
=cut
 ...
 sub x1beg {
	...
	if ( $x1beg ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' x1beg='.$pscontour->{_x1beg};
		$pscontour->{_Step}		= $pscontour->{_Step}.' x1beg='.$pscontour->{_x1beg};
...
=cut
 ...
 sub x1end {
	...
	if ( $x1end ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' x1end='.$pscontour->{_x1end};
		$pscontour->{_Step}		= $pscontour->{_Step}.' x1end='.$pscontour->{_x1end};
...
=cut
 ...
 sub x2beg {
	...
	if ( $x2beg ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' x2beg='.$pscontour->{_x2beg};
		$pscontour->{_Step}		= $pscontour->{_Step}.' x2beg='.$pscontour->{_x2beg};
...
=cut
 ...
 sub x2end {
	...
	if ( $x2end ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' x2end='.$pscontour->{_x2end};
		$pscontour->{_Step}		= $pscontour->{_Step}.' x2end='.$pscontour->{_x2end};
...
=cut
 ...
 sub xbox {
	...
	if ( $xbox ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' xbox='.$pscontour->{_xbox};
		$pscontour->{_Step}		= $pscontour->{_Step}.' xbox='.$pscontour->{_xbox};
...
=cut
 ...
 sub ybox {
	...
	if ( $ybox ne $empty_string ) {
		...
		$pscontour->{_note}		= $pscontour->{_note}.' ybox='.$pscontour->{_ybox};
		$pscontour->{_Step}		= $pscontour->{_Step}.' ybox='.$pscontour->{_ybox};
