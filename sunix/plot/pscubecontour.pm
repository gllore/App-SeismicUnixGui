...
PACKAGE NAME:  PSCCONTOUR - PostScript Contour plot of a data CUBE		        
AUTHOR: Juan Lorenzo
DATE:   
DESCRIPTION:
Version: 
...
=cut
 ...
 sub angle {
	...
	if ( $angle ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' angle='.$pscubecontour->{_angle};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' angle='.$pscubecontour->{_angle};
...
=cut
 ...
 sub axescolor {
	...
	if ( $axescolor ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' axescolor='.$pscubecontour->{_axescolor};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' axescolor='.$pscubecontour->{_axescolor};
...
=cut
 ...
 sub c {
	...
	if ( $c ne $empty_string ) {
		...
		$pscubecontour->{_c}		= $c;
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' c='.$pscubecontour->{_c};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' c='.$pscubecontour->{_c};
...
=cut
 ...
 sub ccolor {
	...
	if ( $ccolor ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' ccolor='.$pscubecontour->{_ccolor};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' ccolor='.$pscubecontour->{_ccolor};
...
=cut
 ...
 sub cdash {
	...
	if ( $cdash ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' cdash='.$pscubecontour->{_cdash};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' cdash='.$pscubecontour->{_cdash};
...
=cut
 ...
 sub cgray {
	...
	if ( $cgray ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' cgray='.$pscubecontour->{_cgray};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' cgray='.$pscubecontour->{_cgray};
...
=cut
 ...
 sub cwidth {
	...
	if ( $cwidth ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' cwidth='.$pscubecontour->{_cwidth};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' cwidth='.$pscubecontour->{_cwidth};
...
=cut
 ...
 sub d1 {
	...
	if ( $d1 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d1='.$pscubecontour->{_d1};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d1='.$pscubecontour->{_d1};
...
=cut
 ...
 sub d1num {
	...
	if ( $d1num ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d1num='.$pscubecontour->{_d1num};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d1num='.$pscubecontour->{_d1num};
...
=cut
 ...
 sub d1s {
	...
	if ( $d1s ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d1s='.$pscubecontour->{_d1s};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d1s='.$pscubecontour->{_d1s};
...
=cut
 ...
 sub d2 {
	...
	if ( $d2 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d2='.$pscubecontour->{_d2};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d2='.$pscubecontour->{_d2};
...
=cut
 ...
 sub d2num {
	...
	if ( $d2num ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d2num='.$pscubecontour->{_d2num};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d2num='.$pscubecontour->{_d2num};
...
=cut
 ...
 sub d2s {
	...
	if ( $d2s ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d2s='.$pscubecontour->{_d2s};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d2s='.$pscubecontour->{_d2s};
...
=cut
 ...
 sub d3 {
	...
	if ( $d3 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d3='.$pscubecontour->{_d3};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d3='.$pscubecontour->{_d3};
...
=cut
 ...
 sub d3num {
	...
	if ( $d3num ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d3num='.$pscubecontour->{_d3num};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d3num='.$pscubecontour->{_d3num};
...
=cut
 ...
 sub d3s {
	...
	if ( $d3s ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' d3s='.$pscubecontour->{_d3s};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' d3s='.$pscubecontour->{_d3s};
...
=cut
 ...
 sub dc {
	...
	if ( $dc ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' dc='.$pscubecontour->{_dc};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' dc='.$pscubecontour->{_dc};
...
=cut
 ...
 sub f1 {
	...
	if ( $f1 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' f1='.$pscubecontour->{_f1};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' f1='.$pscubecontour->{_f1};
...
=cut
 ...
 sub f1num {
	...
	if ( $f1num ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' f1num='.$pscubecontour->{_f1num};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' f1num='.$pscubecontour->{_f1num};
...
=cut
 ...
 sub f2 {
	...
	if ( $f2 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' f2='.$pscubecontour->{_f2};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' f2='.$pscubecontour->{_f2};
...
=cut
 ...
 sub f2num {
	...
	if ( $f2num ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' f2num='.$pscubecontour->{_f2num};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' f2num='.$pscubecontour->{_f2num};
...
=cut
 ...
 sub f3 {
	...
	if ( $f3 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' f3='.$pscubecontour->{_f3};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' f3='.$pscubecontour->{_f3};
...
=cut
 ...
 sub f3num {
	...
	if ( $f3num ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' f3num='.$pscubecontour->{_f3num};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' f3num='.$pscubecontour->{_f3num};
...
=cut
 ...
 sub faces {
	...
	if ( $faces ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' faces='.$pscubecontour->{_faces};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' faces='.$pscubecontour->{_faces};
...
=cut
 ...
 sub fc {
	...
	if ( $fc ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' fc='.$pscubecontour->{_fc};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' fc='.$pscubecontour->{_fc};
...
=cut
 ...
 sub grid1 {
	...
	if ( $grid1 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' grid1='.$pscubecontour->{_grid1};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' grid1='.$pscubecontour->{_grid1};
...
=cut
 ...
 sub grid2 {
	...
	if ( $grid2 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' grid2='.$pscubecontour->{_grid2};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' grid2='.$pscubecontour->{_grid2};
...
=cut
 ...
 sub grid3 {
	...
	if ( $grid3 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' grid3='.$pscubecontour->{_grid3};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' grid3='.$pscubecontour->{_grid3};
...
=cut
 ...
 sub gridcolor {
	...
	if ( $gridcolor ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' gridcolor='.$pscubecontour->{_gridcolor};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' gridcolor='.$pscubecontour->{_gridcolor};
...
=cut
 ...
 sub label1 {
	...
	if ( $label1 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' label1='.$pscubecontour->{_label1};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' label1='.$pscubecontour->{_label1};
...
=cut
 ...
 sub label2 {
	...
	if ( $label2 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' label2='.$pscubecontour->{_label2};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' label2='.$pscubecontour->{_label2};
...
=cut
 ...
 sub label3 {
	...
	if ( $label3 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' label3='.$pscubecontour->{_label3};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' label3='.$pscubecontour->{_label3};
...
=cut
 ...
 sub labelccolor {
	...
	if ( $labelccolor ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelccolor='.$pscubecontour->{_labelccolor};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelccolor='.$pscubecontour->{_labelccolor};
...
=cut
 ...
 sub labelcf {
	...
	if ( $labelcf ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelcf='.$pscubecontour->{_labelcf};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelcf='.$pscubecontour->{_labelcf};
...
=cut
 ...
 sub labelcfont {
	...
	if ( $labelcfont ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelcfont='.$pscubecontour->{_labelcfont};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelcfont='.$pscubecontour->{_labelcfont};
...
=cut
 ...
 sub labelcper {
	...
	if ( $labelcper ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelcper='.$pscubecontour->{_labelcper};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelcper='.$pscubecontour->{_labelcper};
...
=cut
 ...
 sub labelcsize {
	...
	if ( $labelcsize ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelcsize='.$pscubecontour->{_labelcsize};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelcsize='.$pscubecontour->{_labelcsize};
...
=cut
 ...
 sub labelfont {
	...
	if ( $labelfont ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelfont='.$pscubecontour->{_labelfont};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelfont='.$pscubecontour->{_labelfont};
...
=cut
 ...
 sub labelsize {
	...
	if ( $labelsize ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' labelsize='.$pscubecontour->{_labelsize};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' labelsize='.$pscubecontour->{_labelsize};
...
=cut
 ...
 sub n1 {
	...
	if ( $n1 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' n1='.$pscubecontour->{_n1};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' n1='.$pscubecontour->{_n1};
...
=cut
 ...
 sub n1tic {
	...
	if ( $n1tic ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' n1tic='.$pscubecontour->{_n1tic};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' n1tic='.$pscubecontour->{_n1tic};
...
=cut
 ...
 sub n2tic {
	...
	if ( $n2tic ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' n2tic='.$pscubecontour->{_n2tic};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' n2tic='.$pscubecontour->{_n2tic};
...
=cut
 ...
 sub n3tic {
	...
	if ( $n3tic ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' n3tic='.$pscubecontour->{_n3tic};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' n3tic='.$pscubecontour->{_n3tic};
...
=cut
 ...
 sub nc {
	...
	if ( $nc ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' nc='.$pscubecontour->{_nc};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' nc='.$pscubecontour->{_nc};
...
=cut
 ...
 sub nlabelc {
	...
	if ( $nlabelc ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' nlabelc='.$pscubecontour->{_nlabelc};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' nlabelc='.$pscubecontour->{_nlabelc};
...
=cut
 ...
 sub nplaces {
	...
	if ( $nplaces ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' nplaces='.$pscubecontour->{_nplaces};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' nplaces='.$pscubecontour->{_nplaces};
...
=cut
 ...
 sub size1 {
	...
	if ( $size1 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' size1='.$pscubecontour->{_size1};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' size1='.$pscubecontour->{_size1};
...
=cut
 ...
 sub size2 {
	...
	if ( $size2 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' size2='.$pscubecontour->{_size2};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' size2='.$pscubecontour->{_size2};
...
=cut
 ...
 sub size3 {
	...
	if ( $size3 ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' size3='.$pscubecontour->{_size3};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' size3='.$pscubecontour->{_size3};
...
=cut
 ...
 sub title {
	...
	if ( $title ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' title='.$pscubecontour->{_title};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' title='.$pscubecontour->{_title};
...
=cut
 ...
 sub titlecolor {
	...
	if ( $titlecolor ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' titlecolor='.$pscubecontour->{_titlecolor};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' titlecolor='.$pscubecontour->{_titlecolor};
...
=cut
 ...
 sub titlefont {
	...
	if ( $titlefont ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' titlefont='.$pscubecontour->{_titlefont};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' titlefont='.$pscubecontour->{_titlefont};
...
=cut
 ...
 sub titlesize {
	...
	if ( $titlesize ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' titlesize='.$pscubecontour->{_titlesize};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' titlesize='.$pscubecontour->{_titlesize};
...
=cut
 ...
 sub x1beg {
	...
	if ( $x1beg ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' x1beg='.$pscubecontour->{_x1beg};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' x1beg='.$pscubecontour->{_x1beg};
...
=cut
 ...
 sub x1end {
	...
	if ( $x1end ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' x1end='.$pscubecontour->{_x1end};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' x1end='.$pscubecontour->{_x1end};
...
=cut
 ...
 sub x2beg {
	...
	if ( $x2beg ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' x2beg='.$pscubecontour->{_x2beg};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' x2beg='.$pscubecontour->{_x2beg};
...
=cut
 ...
 sub x3end {
	...
	if ( $x3end ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' x3end='.$pscubecontour->{_x3end};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' x3end='.$pscubecontour->{_x3end};
...
=cut
 ...
 sub xbox {
	...
	if ( $xbox ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' xbox='.$pscubecontour->{_xbox};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' xbox='.$pscubecontour->{_xbox};
...
=cut
 ...
 sub ybox {
	...
	if ( $ybox ne $empty_string ) {
		...
		$pscubecontour->{_note}		= $pscubecontour->{_note}.' ybox='.$pscubecontour->{_ybox};
		$pscubecontour->{_Step}		= $pscubecontour->{_Step}.' ybox='.$pscubecontour->{_ybox};
