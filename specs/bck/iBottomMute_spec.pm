...
sub get_binding_index_aref {
    ...
    if ( $iBottomMute_spec->{_binding_index_aref} ) {
        ...
        print(
"iBottomMute_spec, get_binding_index_aref, missing binding_index_aref\n"
        );
        return ();
    }
...
sub get_file_dialog_type_aref {
    ...
    if ( $iBottomMute_spec->{_file_dialog_type_aref} ) {
        ...
        print(
"iBottomMute_spec,get_file_dialog_type_aref, missing file_dialog_type_aref\n"
        );
        return ();
    }
}
...
sub get_flow_type_aref {
    ...
    if ( $iBottomMute_spec->{_flow_type_aref} ) {
        ...
        print(
            "iBottomMute_spec, get_flow_type_aref, missing flow_type_aref \n" );
        return ();
    }
}
