...
sub _basic_dirs {
   ...
   # print("1. Project_config,_basic_dirs,using local $prog_name_old.config\n");
	...
	if ( -e $prog_name_old . '.config' ) {
		...
		print(
			"1a. Project_config,_basic_dirs,using local $prog_name_old.config \n"
		);
...
# print(" 3. Project_config,_basic_dirs,ref_DIR:@{$Project->{_ref_DIR_FUNCTION}}\n");
	 ...
	 # print(" Project_config, _basic_dirs, ACTIVE_PROJECT: $ACTIVE_PROJECT\n");
		...
		print(
			"Project_config, _basic_dirs, Project.config in user configuration dir. created\n"
		);
...
sub _system_dirs {
  ...
  # print(" Project_config, _system_dirs, Before subUser: $subUser \n");
	...
	my $RAYINVR = $SEISMIC
		. '/rayinvr/' . $DATE_LINE_COMPONENT_STAGE_PROCESS . '/' . $subUser;
...
#	print("Project_config,DATA_SEISMIC_SU=$DATA_SEISMIC_SU\n");
...
sub PL_SEISMIC {
	...
	# print("Project_config,PL_SEISMIC=$PL_SEISMIC\n");
