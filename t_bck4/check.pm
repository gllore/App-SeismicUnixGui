...
=cut
	...
	#
	#	system(" sudo -i -u $PL_SEISMIC_SU/suop2.pl ");
	#	$file_name[0] =  '79.su';
...
sub get_instructions {
	...
	my $PL_SEISMIC_SU = $HOME . '/Servilleta_demos/seismics/pl/loma_blanca/050318/H/1/su/gom';
	$instruction[0] = (" sudo -i -u $PL_SEISMIC_SU/suop2.pl ");
