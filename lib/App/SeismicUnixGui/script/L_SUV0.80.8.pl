...
=head2 SYNOPSIS 
 ...
 PERL PROGRAM NAME: L_SUV0.80.8.pl 
 AUTHOR: 	Juan Lorenzo
 DATE: 		June 22 2017 
...
my @Help_option;
$Help_option[1] = $help_menubutton_type->{_About};
$Help_option[0] = $help_menubutton_type->{_Installation};
...
in L_SU
	...
	possible values: 'Open', 'SaveAs', 'Delete'
	
	-help_menubutton with 2 possible values:
	Installation
	About
