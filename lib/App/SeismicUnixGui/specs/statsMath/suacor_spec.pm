package App::SeismicUnixGui::specs::statsMath::suacor_spec;
use Moose;
our $VERSION = '0.0.1';
...
use App::SeismicUnixGui::sunix::statsMath::suacor;
...
sub get_binding_index_aref {
    ...
    if ( $suacor_spec->{_binding_index_aref} ) {
        ...
        print(
            "suacor_spec, get_binding_index_aref, missing binding_index_aref\n"
        );
        return ();
    }
...
sub get_file_dialog_type_aref {
    ...
    if ( $suacor_spec->{_file_dialog_type_aref} ) {
        ...
        print(
"suacor_spec,get_file_dialog_type_aref, missing file_dialog_type_aref\n"
        );
        return ();
    }
