...
use App::SeismicUnixGui::sunix::data::wpccompress;
my $get         = new L_SU_global_constants();
my $Project     = new Project_config;
my $wpccompress = new wpccompress;
...
sub binding_index_aref {
	...
	$wpccompress_spec->{_binding_index_aref} = \@index;
	return ();
...
sub flow_type_aref {
	...
	$wpccompress_spec->{_flow_type_aref} = \@type;
	return ();
...
sub get_file_dialog_type_aref {
	...
	my $self = @_;
	if ( $wpccompress_spec->{_file_dialog_type_aref} ) {
...
sub get_flow_type_aref {
	...
	if ( $wpccompress_spec->{_flow_type_aref} ) {
...
sub get_prefix_aref {
	...
	if ( $wpccompress_spec->{_prefix_aref} ) {
...
sub get_suffix_aref {
	...
	if ( $wpccompress_spec->{_suffix_aref} ) {
...
sub prefix_aref {
	...
	$wpccompress_spec->{_prefix_aref} = \@prefix;
	return ();
...
sub suffix_aref {
	...
	$wpccompress_spec->{_suffix_aref} = \@suffix;
	return ();
