...
//  if(verbose == TRUE) printf("zstart= %f z_increment= %f num_pts_log= %f \n\n",zstart, z_increment, num_pts_log);
//
...
// /* if( labs(Refl_coef[i]) < Refl_coef[0]/threshold) Refl_coef[i]=0.;*/
//
//    if( verbose == TRUE) {
...
//  if(verbose == TRUE) printf("Regularizing reflection coefficients in time\n");
