package App::SeismicUnixGui::misc::param_flow_grey;
...
#		print("param_flow_grey, _get_values_aref, @values_aref, index=$item_index\n");
		return ( \@values_aref );
	}
}
...
#			print("NADA,param_flow_grey, _set_good_values_4item: no values are present, can not be saved\n");
		}
	}
...
#		my $ans = @{@{$param_flow_grey->{_good_values_aref2}}[0]};
#		print("param_flow_grey,get_good_values_aref2,good_values for index=0:$ans\n");
