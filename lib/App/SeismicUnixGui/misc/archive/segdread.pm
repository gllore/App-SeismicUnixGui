...
sub errmax {
    ...
    if ($errmax) {
        ...
        $segdread->{_Step} =
          $segdread->{_Step} . ' errmax=' . $segdread->{_errmax};
        $segdread->{_note} =
          $segdread->{_note} . ' errmax=' . $segdread->{_errmax};
    }
}
...
sub pivot_year {
    ...
    if ($pivot_year) {
        ...
        $segdread->{_Step} =
          $segdread->{_Step} . ' pivot_year=' . $segdread->{_pivot_year};
        $segdread->{_note} =
          $segdread->{_note} . ' pivot_year=' . $segdread->{_pivot_year};
    }
}
...
sub ptmax {
    ...
    if ($ptmax) {
        ...
        $segdread->{_Step} =
          $segdread->{_Step} . ' ptmax=' . $segdread->{_ptmax};
        $segdread->{_note} =
          $segdread->{_note} . ' ptmax=' . $segdread->{_ptmax};
    }
}
...
sub ptmin {
    ...
    if ($ptmin) {
        ...
        $segdread->{_Step} =
          $segdread->{_Step} . ' ptmin=' . $segdread->{_ptmin};
        $segdread->{_note} =
          $segdread->{_note} . ' ptmin=' . $segdread->{_ptmin};
    }
}
...
sub use_stdio {
    ...
    if ($use_stdio) {
        ...
        $segdread->{_Step} =
          $segdread->{_Step} . ' use_stdio=' . $segdread->{_use_stdio};
        $segdread->{_note} =
          $segdread->{_note} . ' use_stdio=' . $segdread->{_use_stdio};
    }
}
...
sub vblock {
    ...
    if ($vblock) {
        ...
        print 'vblock=' . $vblock . "\n\n";
        $segdread->{_Step} =
          $segdread->{_Step} . ' vblock=' . $segdread->{_vblock};
        $segdread->{_note} =
            $segdread->{_note}
...
sub verbose {
    ...
    if ($verbose) {
        ...
        $segdread->{_Step} =
          $segdread->{_Step} . ' verbose=' . $segdread->{_verbose};
        $segdread->{_note} =
          $segdread->{_note} . ' verbose=' . $segdread->{_verbose};
    }
}
