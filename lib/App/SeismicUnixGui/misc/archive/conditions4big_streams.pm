...
# 		print("2208 conditions4big_streams,set4end_of_add2flow\n");
...
# 		print("2295 conditions4big_streams,set4end_of_add2flow_button  flow_listbox_color_w: $flow_listbox_color_w\n");
...
sub set4start_of_superflow_select {
	...
	print("2682 conditions4big_streams, set4superflow_open_data_file_start OK \n");
	use App::SeismicUnixGui::misc::L_SU_global_constants;
	my $get         = L_SU_global_constants->new();
	my $flow_type_h = $get->flow_type_href();
