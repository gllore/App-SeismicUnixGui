...
sub set_specs {
	...
	if ( $length > 1 ) {
		...
		print("1.Warning  Only one item in flow--flow may not run: oop_flows,set_specs,length = 0 or 1 \n");
		...
		print("2.Warning No item in flow--flow will not run: oop_flows,set_specs,length = 0 \n");
...
#					print("oop_flows,set_specs,second_last_idx=$second_last_idx\n");
					...
					$message_w->delete( "1.0", 'end' );
					$message_w->insert( 'end', $message );
					print(" Warning:  3. unexpected last item (oop_flows,set_specs)\n");
					print(" Warning: 3 Last item is not allowed. Use data_out or program (oop_flows,set_specs)\n");
				}
				...
				$message_w->delete( "1.0", 'end' );
				$message_w->insert( 'end', $message );
				print(" Warning: 4. unexpected last item (oop_flows,set_specs)\n");
				print(" Warning: 4. Last item is not allowed. Use data_out or program (oop_flows,set_specs)\n");
			}
			...
			if ( $specs[$last_idx]->{_is_last_of_4or_more} ) {
				...
				if ( $corrected_prog_names[$last_idx] eq 'data_out' ) {
					...
					$message_w->delete( "1.0", 'end' );
					$message_w->insert( 'end', $message );
					print(" Warning:  1. unexpected last item (oop_flows,set_specs)\n");
					print(" Warning: 1 Last item is not allowed. Use data_out or program (oop_flows,set_specs)\n");
				}
				...
				$message_w->delete( "1.0", 'end' );
				$message_w->insert( 'end', $message );
				print(" Warning:  2. unexpected last item (oop_flows,set_specs)\n");
				print(" Warning: 2 Last item is not allowed. Use data_out or program (oop_flows,set_specs)\n");
