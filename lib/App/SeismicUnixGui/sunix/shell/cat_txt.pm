...
# sub  Step {
#
#	$cat_txt->{_Step}     = 'cat'.$cat_txt->{_Step};
#	return ( $cat_txt->{_Step} );
#
# }
#
#
...
# sub  note {
#
#	$cat_txt->{_note}     = 'cat'.$cat_txt->{_note};
#	return ( $cat_txt->{_note} );
#
# }
#
#
...
# sub clear {
#
#		$cat_txt->{_base_file_name1}			= '';
#		$cat_txt->{_base_file_name2}			= '';
#		$cat_txt->{_Step}			= '';
#		$cat_txt->{_note}			= '';
# }
#
...
#
#		$cat_txt->{_base_file_name1}		= $base_file_name1;
#		$cat_txt->{_note}		= $cat_txt->{_note}.' '.$cat_txt->{_base_file_name1};
#		$cat_txt->{_Step}		= $cat_txt->{_Step}.' '.$cat_txt->{_base_file_name1};
#
#	} else { 
#		print("cat_txt, base_file_name1, missing base_file_name1,\n");
#	 }
# }
#
#
...
#
#		$cat_txt->{_base_file_name2}		= $base_file_name2;
#		$cat_txt->{_note}		= $cat_txt->{_note}.' '.$cat_txt->{_base_file_name2};
#		$cat_txt->{_Step}		= $cat_txt->{_Step}.' '.$cat_txt->{_base_file_name2};
#
#	} else { 
#		print("cat_txt, base_file_name2, missing base_file_name2,\n");
#	 }
# }
#
#
