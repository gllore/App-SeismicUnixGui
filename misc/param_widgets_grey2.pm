...
sub get_check_buttons_aref {
	...
	# print("param_widgets_grey,get_check_buttons_aref: @{$param_widgets_color_href->{_check_buttons_settings_aref}}\n");
...
sub set_labels {
	...
	# my $length = scalar @{ $param_widgets_color_href->{_labels_aref} };
	# print("param_widgets_grey2,set_labels, length=$length\n");
	return ();
}
