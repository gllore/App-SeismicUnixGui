...
#					print(" param_widgets_pink, _check_value_changes, _parameter_index_on_entry: $ans \n");
			...
			# print(" param_widgets_pink, changes, bad index NADA \n");
		}
	} else {
		print("param_widgets_pink, changes,missing  prog_name\n");
	}
...
=cut
	...
	sub _check_value_changes {
		...
		#	print(
		#		" 1. param_widgets_pink, _check_value_changes, entry_in_switch=$param_widgets->{_entry_in_switch}, index=$param_widgets->{_index}\n"
		#	);
...
#			print(" 2. param_widgets_pink, _check_value_changes, entry_in_switch=$ans\n");			
			...
			# print(" 1. param_widgets_pink, _check_value_changes, on_entry print gui_history.txt\n");
			# $gui_history->view();
...
#			print(" 2. param_widgets_pink, _check_value_changes, entry_in_switch=$ans\n");	
			...
			# print(" 2. param_widgets_pink, _check_value_changes, _on_exit, print gui_history.txt\n");
			# $gui_history->view();
	...
	#	my $ans = $array[0]->get();
	#	print(" 1. param_widgets_pink, _update_value_changes, array of widget Entry values:$ans \n");
	#	$ans = $array[1]->get();
	#	print(" 1. param_widgets_pink, _update_value_changes, array of widget Entry values:$ans \n");
...
sub _update_value_changes {
	...
	if ( $param_widgets->{_entry_in_switch} eq $off ) {
		...
		print(" 1. param_widgets_pink, _update_value_changes, missing value\n");
	}
...
sub range {
	...
	# for sunix selections
		...
		#print("2. param_widgets_pink,range, inital selection of sunix program \n
...
#
#				print(
#					"param_widgets_pink,set_entry_button_chosen,value= @{$param_widgets_color_href->{_values_w_aref}}[$choice]\n"
#				);
