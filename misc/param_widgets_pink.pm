...
sub _changes {
	...
	if ( $param_widgets_color_href->{_current_program_name} ) {
		...
		if ( $entry_in_switch eq $off ) {    # =0
			...
			$gui_history->set_parameter_index_on_entry($idx);
			$gui_history->set_parameter_color_on_entry($this_color);

			# print(" 1. param_widgets_pink, _changes, on_entry print gui_history.txt\n");
			# $gui_history->view();
			...
			# print(" 2. param_widgets_pink, _changes, _on_exit, print gui_history.txt\n");
			# $gui_history->view();
		}
		else {
...
sub set_labels {
 ...
 #       print("param_widgets_pink,set_labels\n");
	if ( defined $labels_aref ) {
		...
		print("param_widgets_pink,set_labels, missinglabels\n")
			;
	}
	return ();
}
