...
sub offset{
	my($ref_X_SP,$ref_Y_SP,$ref_Z_SP,$num_SP,$ref_SP,$ref_X_GEOP,$ref_Y_GEOP,$ref_Z_GEOP,$num_GEOP,$ref_GEOP)
 = @_;
   ...
   for ($j=1; $j<=$num_SP; $j++) {
	...
	for ($i=1; $i<=$num_GEOP; $i++) {
		...
		$dist[$j][$i] = sqrt( ($$ref_X_SP[$j]-$$ref_X_GEOP[$i])*($$ref_X_SP[$j]-$$ref_X_GEOP[$i]) +($$ref_Y_SP[$j] -$$ref_Y_GEOP[$i])*($$ref_Y_SP[$j] -$$ref_Y_GEOP[$i])+ ($$ref_Z_SP[$j] -$$ref_Z_GEOP[$i])*($$ref_Z_SP[$j] -$$ref_Z_GEOP[$i])  );
...
#		print("\n Z of SP [$j] is $$ref_Z_SP[$j] \n");
		...
		$dist[$j] = sqrt( ($$ref_X_SP[$j]-$$ref_X_GEOP[$j])*($$ref_X_SP[$j]-$$ref_X_GEOP[$j]) +($$ref_Y_SP[$j] -$$ref_Y_GEOP[$j])*($$ref_Y_SP[$j] -$$ref_Y_GEOP[$j])+ ($$ref_Z_SP[$j] -$$ref_Z_GEOP[$j])*($$ref_Z_SP[$j] -$$ref_Z_GEOP[$j])  );
