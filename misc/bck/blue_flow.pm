...
sub _add2flow {
    ...
    _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
   				...
   				# print("8. color_flow, add2flow_button, _is_flow_listbox_blue_w $color_flow->{_is_flow_listbox_blue_w}\n");
    ...
    # because focus is transferred to a flow list box  (blue)
   ...
   _stack_versions();
	...
	$color_flow			->{_is_last_parameter_index_touched_blue} 	= $true;
   	
   	# print("1. color_flow, _add2flow, color_flow->{_flow_type: $color_flow->{_flow_type} \n");
   	
   	# print("1. color_flow, _add2flow, is_last_parameter_index_touched_blue: $color_flow->{_is_last_parameter_index_touched_blue} \n");
...
##########		
		...
		$color_flow->{_is_last_flow_index_touched_blue} 	= $true;
...
sub _perl_flow {	
    ...
    # print("color_flow,flow_listbox_color_w, $flow_listbox_blue_w, _perl_flow\n");
...
if ($flow_color eq 'blue')  {
		...
		# print("color_flow,_set_flow_name_color_w, flow_name_color_w,   $color_flow->{_flow_name_blue_w} \n");
...
sub _set_is_last_parameter_index_touched_color {	
	...
	if ($flow_color eq 'blue') {
		...
		$color_flow->{_is_last_parameter_index_touched_color}	=  $color_flow->{_is_last_parameter_index_touched_blue};
			...
			print("color_flow,_set_is_last_parameter_index_touched_color, is_last_parameter_index_touched_blue: $color_flow->{_is_last_parameter_index_touched_blue}\n");
...
sub _set_last_parameter_index_touched_color {	
	...
	if ($flow_color eq 'blue') {
		...
		$color_flow->{_last_parameter_index_touched_color}	=  $color_flow->{_last_parameter_index_touched_blue};
			...
			print("color_flow,_set_last_parameter_index_touched_color, last_parameter_index_touched_blue: $color_flow->{_last_parameter_index_touched_blue}\n");
...
=cut 
 ...
 sub FileDialog_button {   # N.B., Another _FileDialog_button in L_SU.pm needs to be updated too!!!!!!!
	...
	if ($dialog_type_sref)  {
		...
		# print ("2. color_flow,FileDialog_button, is_last_flow_index_touched: $color_flow->{_is_last_flow_index_touched_blue} \n");		
		...
		if ($topic eq $file_dialog_type->{_SaveAs} ) {
				...
				# print ("0. color_flow,FileDialog_button, is_last_parameter_index_touched: $color_flow->{_is_last_parameter_index_touched_blue} \n");
				# print ("0. color_flow,FileDialog_button, is_last_flow_index_touched: $color_flow->{_is_last_flow_index_touched_blue} \n");
			$color_flow			->{_values_aref}  = $param_widgets->get_values_aref();
			...
			# print ("1. color_flow,FileDialog_button, is_last_parameter_index_touched: $color_flow->{_is_last_parameter_index_touched_blue} \n");
			# print ("1. color_flow,FileDialog_button, is_last_flow_index_touched: $color_flow->{_is_last_flow_index_touched_blue} \n");
			
			$file_dialog 		->FileDialog_director();
		
			# print ("2. color_flow,FileDialog_button, is_last_parameter_index_touched: $color_flow->{_is_last_parameter_index_touched_blue} \n");
...
#			print ("1. color_flow,FileDialog_button, color: $flow_color \n");
			$color_flow->{_is_last_parameter_index_touched_blue} 	= $true;
#			print("color_flow,FileDialog_button,_is_flow_listbox_blue_w:	$color_flow->{_is_flow_listbox_blue_w} \n");
			_check4parameter_changes();
			...
			if( !($color_flow->{_flow_name_out}) 			||
				...
				my $message          = $color_flow_messages->save_button(1);
			 	...
			 	# displays user-built flow name at top of blue-flow gui
			...
			if ($file_exists) {
				...
				# Place names of the programs at the head of the blue listbox					
  				$flow_name_color_w     -> configure(-text => $color_flow->{_flow_name_in});
    		
    			# $color_flow->{_flow_name_blue_w}     -> configure(-text => $color_flow->{_flow_name_in});
				...
				# print("3 color_flow,FileDialog_button,_is_last_flow_index_touched_blue:$color_flow->{_is_last_flow_index_touched_blue} \n");
 							
			} else {				
				# print ("color_flow, FileDialog_button, file does not exist\n");
			}	
						
#			print("3 color_flow,FileDialog_button,_is_flow_listbox_blue_w:	$color_flow->{_is_flow_listbox_blue_w} \n");
		...
		# print ("2. color_flow,FileDialog_button, is_last_parameter_index_touched_color: $color_flow->{_is_last_parameter_index_touched_blue} \n");
		# print ("2. color_flow,FileDialog_button, is_last_flow_index_touched: $color_flow->{_is_last_flow_index_touched_blue} \n");
		return();
 }
...
sub add2flow_button {
   ...
   _stack_versions();
	...
	$color_flow			->{_is_last_parameter_index_touched_blue} 	= $true;
			...
			# print("22. color_flow, add2flow_button, _is_flow_listbox_blue_w $color_flow->{_is_flow_listbox_blue_w}\n");
		    	...
		    	# print("27. color_flow,add2flow_button,last blue-flow program touched had index: $color_flow->{_last_flow_index_touched}\n");
				...
				# print("31. color_flow add2flow_button: _is_last_parameter_index_touched_blue $color_flow->{_is_last_parameter_index_touched_blue}\n");
	# print("color_flow,add2flow,_is_flow_listbox_blue_w:	$color_flow->{_is_flow_listbox_blue_w} \n");
	flow_select();
	...
	my ($self) = @_;
 	...
 	if ($flow_color)  {
		...
		$color_flow 			= $conditions_gui->get_hash_ref(); # find out if delete button is active    64 returned / 72 max
			...
			# print("1. color_flow,delete_from_flow_button , is_flow_listbox_blue_w  $color_flow->{_is_flow_listbox_color_w} \n");
...
# 	if( $prog_name && $flow_widgets->is_drag_deleted($flow_listbox_blue_w) ) {
# 		
# 		# switch between instances of the correct param_flow_color 
#		# param_flow_color stores Data 
#		_set_param_flow_color_i($flow_color);
...
#        my $this_index = $flow_widgets->get_drag_deleted_index($flow_listbox_blue_w);
#
...
#  	}						  
	...
	my $num_items = $flow_widgets->get_num_items($flow_listbox_blue_w);
  						# print("color_flowdrag,num items prior to deletion  = $num_items\n");

  	if ( $num_items > 1 ) {  # num_items PRIOR to deletion
   	   $flow_widgets->drag_start($dnd_token_blue);
	    				# print("color_flowdrag,start dnd_token_blue:$dnd_token_blue\n");
  	} else {
...
sub drop {
   my ($self) 						= @_;   
   my $done;
   my $chosen_index_to_drop 		= $flow_widgets->drag_end($dnd_token_blue);
   my $prog_name;
   ...
   if ($prog_name && $chosen_index_to_drop && $chosen_index_to_drop>=0  ) {   # same as destination_index
    ...
    #$flow_listbox_blue_w    ->selectionSet( $color_flow->{_destination_index},);
		...
		if ( $prog_name  && 
			...
			$color_flow->{_index2move} 			= $current_flow_listbox_index;
     		$color_flow->{_destination_index} 	= $destination_index;
     	 	...
     	 	# modify flow listbox
     	 	# _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
   			 # print("3. color_flow,flow_item_down_arrow_button , _is_flow_listbox_blue_w $color_flow->{_is_flow_listbox_blue_w}\n");
		...
		if ( $prog_name  && 
    		...
    		$color_flow->{_is_last_flow_index_touched_blue} 	= $true;
         	...
         	# modify flow listbox#
     	 	...
     	 	# _set_flow_listbox_color_w($flow_color); # in "color"_flow namespace
   			# print("3. color_flow,flow_item_up_arrow_button , _is_flow_listbox_blue_w $color_flow->{_is_flow_listbox_blue_w}\n");
...
=cut
 ...
 sub flow_select { 
	...
	# print("1.color_flow, flow_select,color->{_is_last_parameter_index_touched_blue}:$color_flow->{_is_last_parameter_index_touched_blue}\n");
	...
	# print("1. color_flow, flow_select, _is_last_parameter_index_touched_blue:$color_flow->{_is_last_parameter_index_touched_blue}, color:$flow_color\n");	
	...
	# print("2. color_flow, flow_select,color->{_is_last_parameter_index_touched_blue}:$color_flow->{_is_last_parameter_index_touched_blue}\n");
	...
	#  independently set conditions to make blue box available
	#  print("8. color_flow, flow_select,_is_flow_listbox_blue_w $color_flow->{_is_flow_listbox_blue_w}\n");
	...
	# program
		...
		# print("1 color_flow , flow_select, _is_last_parameter_index_touched_blue :  $color_flow->{_is_last_parameter_index_touched_blue}\n");	
...
#			}	# end deletion	bydragging
		...
		# print("color_flow flow_select: _last_parameter_index_touched $color_flow->{_last_parameter_index_touched_color}\n");
 		...
 		$color_flow->{_names_aref} 			= $param_flow_color_i->get_names_aref();
  		...
  		# print("2. color_flow flow_select,parameter values[0]:@{$color_flow->{_values_aref}}[0], flow_color: $flow_color\n");
  							...
  							# print("2. color_flow flow_select,param_flow_blue: $param_flow_blue, flow_color: $flow_color\n");
  							# print("2. color_flow flow_select,param_flow_blue: $param_flow_blue\, flow_color: $flow_color\n");	
  		# print(" 30. color_flow flow_select,updated param_flow values:@{$color_flow->{_values_aref}}\n");
    	...
    	$prog_name_sref 	= $color_flow->{_prog_name_sref};
    		...
    		# print("color_flow,flow_select,_is_flow_listbox_blue_w:	$color_flow->{_is_flow_listbox_blue_w} \n");	
...
=head2 sub get_last_flow_color
		...
		returns current folor (blue) as the last fow color
