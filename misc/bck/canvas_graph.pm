...
=cut
 ...
 sub _get_canvas_height{
	...
	if ( $canvas_graph->{_x_pix} ne $empty_string ) {
		...
		print("canvas_graph, _get_canvas_height, missing canvas_graph->{_x_pix}\n");
...
=cut
 ...
 sub _get_canvas_width{
	...
	if ( $canvas_graph->{_x_pix} ne $empty_string ) {
		...
		print("canvas_graph, _get_canvas_width, missing canvas_graph->{_x_pix}\n");
		my $result = $empty_string;
		return($result);
	 }
 }
...
=cut
 ...
 sub set_button_pressed {
	...
	if ( $button_pressed ne $empty_string ) {
		...
		print("canvas_graph, set_button_released, missing canvas_graph->{_button_released}\n");
		my $result = $empty_string;
		return($result);
	 }
 }
