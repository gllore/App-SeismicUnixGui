...
=cut
 ...
 sub set_gui_widgets {
 	...
 	if ( $widget_hash_ref) {
      	...
      	$conditions_gui->{_Data_menubutton}			= $widget_hash_ref->{_Data_menubutton};		
      	$conditions_gui->{_Flow_menubutton}			= $widget_hash_ref->{_Flow_menubutton};
     	$conditions_gui->{_SaveAs_menubutton}		= $widget_hash_ref->{_SaveAs_menubutton};      				
 		...
 		$conditions_gui->{_delete_from_flow_button} = $widget_hash_ref->{_delete_from_flow_button};
   		...
   		$conditions_gui->{_flowNsuperflow_name_w} 	= $widget_hash_ref->{_flowNsuperflow_name_w};
     	$conditions_gui->{_flow_color} 				= $widget_hash_ref->{_flow_color};
     	$conditions_gui->{_flow_item_down_arrow_button}	= $widget_hash_ref->{_flow_item_down_arrow_button};
 		$conditions_gui->{_flow_item_up_arrow_button}	= $widget_hash_ref->{_flow_item_up_arrow_button};	
		...
		$conditions_gui->{_parameter_value_index}	= $widget_hash_ref->{_parameter_value_index};
    	...
    	$conditions_gui->{_values_w_aref}			= $widget_hash_ref->{_values_w_aref};
      	...
      	$Data_menubutton			= $conditions_gui->{_Data_menubutton};		
      	$Flow_menubutton			= $conditions_gui->{_Flow_menubutton};
     	$SaveAs_menubutton			= $conditions_gui->{_SaveAs_menubutton};    	  	
    	$add2flow_button_grey		= $conditions_gui->{_add2flow_button_grey};
   		$add2flow_button_pink		= $conditions_gui->{_add2flow_button_pink};
    	$add2flow_button_green		= $conditions_gui->{_add2flow_button_green};
    	$add2flow_button_blue		= $conditions_gui->{_add2flow_button_blue};
    	...
    	# print("conditions_gui, set_gui_widgets , conditions_gui->{_delete_from_flow_button: $conditions_gui->{_delete_from_flow_button}\n");
  	 	# print("conditions_gui,  set_gui_widgets, conditions_gui->{_flowNsuperflow_name_w: $conditions_gui->{_flowNsuperflow_name_w}\n");
...
=cut
 ...
 sub set_hash_ref {
 	...
 	if ( $hash_ref) {
     	...
     	$conditions_gui->{check_buttons_settings_aref}			= $hash_ref->{_check_buttons_settings_aref};		
 		...
 		$conditions_gui->{_dropsite_token_grey}	 				= $hash_ref->{_dropsite_token_grey};
  		$conditions_gui->{_dropsite_token_pink} 				= $hash_ref->{_dropsite_token_pink};
   		$conditions_gui->{_dropsite_token_green} 				= $hash_ref->{_dropsite_token_green};
    	$conditions_gui->{_dropsite_token_blue} 				= $hash_ref->{_dropsite_token_blue};
 		$conditions_gui->{_flow_color} 							= $hash_ref->{_flow_color} ;
 		$conditions_gui->{_flow_item_down_arrow_button} 		= $hash_ref->{_flow_item_down_arrow_button};
 		$conditions_gui->{_flow_item_up_arrow_button} 			= $hash_ref->{_flow_item_up_arrow_button};
		...
		$conditions_gui->{_has_used_check_code_button} 			= $hash_ref->{_has_used_check_code_button};
		$conditions_gui->{_has_used_open_perl_file_button}		= $hash_ref->{_has_used_open_perl_file_button};
		...
		$conditions_gui->{_has_used_Save_superflow} 			= $hash_ref->{_has_used_Save_superflow}; 	
 		...
 		$conditions_gui->{_is_flow_item_down_arrow_button}		= $hash_ref->{_is_flow_item_down_arrow_button};
 		$conditions_gui->{_is_flow_item_up_arrow_button}		= $hash_ref->{_is_flow_item_up_arrow_button};
 		...
 		$conditions_gui->{_is_future_flow_listbox_grey} 		= $hash_ref->{_is_future_flow_listbox_grey};
 		$conditions_gui->{_is_future_flow_listbox_pink} 		= $hash_ref->{_is_future_flow_listbox_pink};
 		$conditions_gui->{_is_future_flow_listbox_green} 		= $hash_ref->{_is_future_flow_listbox_green};
 		$conditions_gui->{_is_future_flow_listbox_blue} 		= $hash_ref->{_is_future_flow_listbox_blue};		
 		$conditions_gui->{_is_last_flow_index_touched}			= $hash_ref->{_is_last_flow_index_touched};
 		$conditions_gui->{_is_last_flow_index_touched_grey}		= $hash_ref->{_is_last_flow_index_touched_grey};
  		$conditions_gui->{_is_last_flow_index_touched_pink}		= $hash_ref->{_is_last_flow_index_touched_pink};
  		$conditions_gui->{_is_last_flow_index_touched_green}	= $hash_ref->{_is_last_flow_index_touched_green};
  		$conditions_gui->{_is_last_flow_index_touched_blue}		= $hash_ref->{_is_last_flow_index_touched_blue};
 		$conditions_gui->{_is_last_parameter_index_touched_color}	= $hash_ref->{_is_last_parameter_index_touched_color};
 		$conditions_gui->{_is_last_parameter_index_touched_grey} 	= $hash_ref->{_is_last_parameter_index_touched_grey};		
 		$conditions_gui->{_is_last_parameter_index_touched_pink} 	= $hash_ref->{_is_last_parameter_index_touched_pink};	
 		$conditions_gui->{_is_last_parameter_index_touched_green} 	= $hash_ref->{_is_last_parameter_index_touched_green};	
 		$conditions_gui->{_is_last_parameter_index_touched_blue} 	= $hash_ref->{_is_last_parameter_index_touched_blue};		
		...
		$conditions_gui->{_is_user_built_flow} 					= $hash_ref->{_is_user_built_flow};
 		$conditions_gui->{_is_select_file_button} 				= $hash_ref->{_is_select_file_button};
   	    $conditions_gui->{_is_selected_file_name}				= $hash_ref->{_is_selected_file_name}; 
 		...
 		$conditions_gui->{_is_sunix_listbox} 					= $hash_ref->{_is_sunix_listbox};
  		...
  		$conditions_gui->{_is_pre_built_superflow}				= $hash_ref->{_is_pre_built_superflow};
   		...
   		$conditions_gui->{_is_superflow}						= $hash_ref->{_is_superflow} ;   # for deprecation TODO
   		$conditions_gui->{_is_moveNdrop_in_flow} 				= $hash_ref->{_is_moveNdrop_in_flow};
   		$conditions_gui->{_last_flow_color}						= $hash_ref->{_last_flow_color}; # used in flow_select 		
   		$conditions_gui->{_last_flow_index_touched}				= $hash_ref->{_last_flow_index_touched};
    	$conditions_gui->{_last_flow_index_touched_grey}		= $hash_ref->{_last_flow_index_touched_grey};
     	$conditions_gui->{_last_flow_index_touched_pink}		= $hash_ref->{_last_flow_index_touched_pink};
      	$conditions_gui->{_last_flow_index_touched_green}		= $hash_ref->{_last_flow_index_touched_green};
      	$conditions_gui->{_last_flow_index_touched_blue}		= $hash_ref->{_last_flow_index_touched_blue};
   		$conditions_gui->{_last_parameter_index_touched_grey}	= $hash_ref->{_last_parameter_index_touched_grey};
    	$conditions_gui->{_last_parameter_index_touched_pink}	= $hash_ref->{_last_parameter_index_touched_pink};
    	$conditions_gui->{_last_parameter_index_touched_green}	= $hash_ref->{_last_parameter_index_touched_green};
    	$conditions_gui->{_last_parameter_index_touched_blue}	= $hash_ref->{_last_parameter_index_touched_blue};
      	$conditions_gui->{_last_parameter_index_touched_color}	= $hash_ref->{_last_parameter_index_touched_color};
      	$conditions_gui->{_occupied_listbox_aref}				= $hash_ref->{_occupied_listbox_aref};
...
sub _get_num_listboxes_occupied {
	...
	if ($conditions_gui->{_occupied_listbox_aref}) {
		...
		my $number = 	@{$conditions_gui->{_occupied_listbox_aref}}[0] +
...
sub set4last_delete_from_flow_button {
	...
	if ($color eq 'grey'  || 
		...
		$flow_item_down_arrow_button		->configure(
	        		-state => 'disabled',
                   );
 		$flow_item_up_arrow_button			->configure(
	        		-state => 'disabled',
	        		);
		...
		print("conditions_gui, set4last_delete_from_flow_button, color missing: $color\n");
	}
 	...
 	if ($color eq 'grey') {
		...
		print("conditions_gui, set4last_delete_from_flow_buttonset, color missing: $color\n");
	}

	my $number = _get_num_listboxes_occupied();
	
		# print("conditions_gui, set4last_delete_from_flow_button, number=$number\n");
	...
	if ( $number < 0) {
		...
		$SaveAs_menubutton->configure(
					-state => 'disabled'
					); 
		# turn off Data menu button
		$Data_menubutton->configure(
					-state => 'disabled'
					); 
		# turn off Flow menu button
		$Flow_menubutton->configure(
					-state => 'normal'
					); 
	  	...
	  	# NADA print("conditions_gui,set4last_delete_from_flow_button, not at the last listbox yet\n");
	}
...
sub set4start_of_delete_from_flow_button {
	...
	if ($color) {
		_reset();
			# print("conditions_gui, set4start_of_delete_from_flow_button, color: $color\n");
   		$conditions_gui->{_is_delete_from_flow_button}	    	= $true;
...
#   				print("conditions_gui, set4start_of_delete_from_flow_button, conditions_gui->$is_flow_listbox_color_w_key: $is_flow_listbox_color_w\n");
#   				print("conditions_gui, set4start_of_delete_from_flow_button, conditions_gui->$flow_listbox_color_w_key: $flow_listbox_color_w\n");
#   				print("conditions_gui, set4start_of_delete_from_flow_button, _is_flow_listbox_color_w_key: $is_flow_listbox_color_w_key\n");
#   				print("conditions_gui, set4start_of_delete_from_flow_button, flow_listbox_color_w_key: $flow_listbox_color_w_key\n");
	...
	if ($color) {
		...
		my $flow_listbox_color_w_txt      	= 'flow_listbox_'.$color.'_w';
   		my $flow_listbox_color_w 			= $conditions_gui->{$flow_listbox_color_w_key};
   	    	...
   	    	# print("conditions_gui, set4start_of_flow_select, color:$color; flow_listbox_color_w =$conditions_gui->{$flow_listbox_color_w_key}\n");
        ...
        if ($color eq 'grey')  {
        	...
        	print("conditions_gui, set4start_of_flow_select, missing color\n");     	
        }
