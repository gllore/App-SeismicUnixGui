...
sub get4FileDialog_SaveAs {
	...
	} elsif ( ( $decisions->{_is_flow_listbox_grey_w} 	|| 
		$decisions->{_is_flow_listbox_pink_w} 			||
		$decisions->{_is_flow_listbox_green_w} 			||
		$decisions->{_is_flow_listbox_blue_w} 			||
...
#					 && ($state[4] && $state[5] && $state[6]) );
   ...
   # if ( $condition || $state[7] ||$state[8] ) {
		...
		print("decisions,get4help, state is false: $false\n");
		print(" decisions,get4flow_select, states: 
		0:$state[0],1:$state[1],02:$state[2],3:$state[3]
...
sub set4FileDialog_select {
	...
	$decisions->{_is_flow_listbox_grey_w}  		= $hash_ref->{_is_flow_listbox_grey_w};
	$decisions->{_is_flow_listbox_pink_w} 		= $hash_ref->{_is_flow_listbox_pink_w}; 
	$decisions->{_is_flow_listbox_green_w} 		= $hash_ref->{_is_flow_listbox_green_w}; 
	$decisions->{_is_flow_listbox_blue_w} 		= $hash_ref->{_is_flow_listbox_blue_w}; 
	$decisions->{_is_flow_listbox_color_w} 		= $hash_ref->{_is_flow_listbox_color_w}; 	
	$decisions->{_is_pre_built_superflow}  		= $hash_ref->{_is_pre_built_superflow}; 
...
sub set4FileDialog_SaveAs {
	...
	$decisions->{_is_flow_listbox_blue_w}  		= $hash_ref->{_is_flow_listbox_blue_w}; 
	$decisions->{_is_pre_built_superflow}  		= $hash_ref->{_is_pre_built_superflow};
	$decisions->{_is_user_built_superflow}  	= $hash_ref->{_is_user_built_superflow};	
...
sub set4delete_from_flow_button{
	...
	$decisions->{_is_flow_listbox_blue_w}		= $hash_ref->{_is_flow_listbox_blue_w};
	$decisions->{_is_flow_listbox_color_w}		= $hash_ref->{_is_flow_listbox_color_w};
	$decisions->{_is_delete_from_flow_button}	= $hash_ref->{_is_delete_from_flow_button};
...
=cut
 ...
 sub set4flow_select {
	...
	if ($hash_ref ) {
		...
		$decisions->{_is_flow_listbox_green_w}  				= $hash_ref->{_is_flow_listbox_green_w};
		$decisions->{_is_flow_listbox_blue_w}  					= $hash_ref->{_is_flow_listbox_blue_w};
		$decisions->{_is_last_flow_index_touched} 				= $hash_ref->{_is_last_flow_index_touched};
		$decisions->{_is_last_flow_index_touched_grey} 			= $hash_ref->{_is_last_flow_index_touched_grey};
		$decisions->{_is_last_flow_index_touched_pink} 			= $hash_ref->{_is_last_flow_index_touched_pink};
		$decisions->{_is_last_flow_index_touched_green} 		= $hash_ref->{_is_last_flow_index_touched_green};
		$decisions->{_is_last_flow_index_touched_blue} 			= $hash_ref->{_is_last_flow_index_touched_blue};
		$decisions->{_is_last_parameter_index_touched_grey} 	= $hash_ref->{_is_last_parameter_index_touched_grey};
		$decisions->{_is_last_parameter_index_touched_pink} 	= $hash_ref->{_is_last_parameter_index_touched_pink};
		$decisions->{_is_last_parameter_index_touched_green} 	= $hash_ref->{_is_last_parameter_index_touched_green};
		$decisions->{_is_last_parameter_index_touched_blue} 	= $hash_ref->{_is_last_parameter_index_touched_blue};
		$decisions->{_is_last_parameter_index_touched_color} 	= $hash_ref->{_is_last_parameter_index_touched_color};

		
		if( defined $hash_ref->{_prog_name_sref} ) { # does it have *_spec.pm and regular *.pm
...
sub set4run_select {
	...
	$decisions->{_has_used_SaveAs_button}       	= $hash_ref->{_has_used_SaveAs_button}; 
	$decisions->{_has_used_Save_button}   	 		= $hash_ref->{_has_used_Save_button};
	$decisions->{_has_used_Save_superflow}    		= $hash_ref->{_has_used_Save_superflow};
	$decisions->{_has_used_open_perl_file_button}	= $hash_ref->{_has_used_open_perl_file_button};
