...
=cut
 ...
 sub get4delete_from_flow_button{
	my ($self) = @_;
	my $here;
    $here->{_is_delete_from_flow_button} 		= $whereami->{_is_delete_from_flow_button};
 ...
 sub get4flow_listbox {
	...
	if ($color) {
		...
		my $is_flow_listbox_color_w_text	 		= '_is_flow_listbox_'.$color.'_w';
   		$here->{_is_flow_listbox_color_w_text}  	= $whereami->{$is_flow_listbox_color_w_text};
   		$here->{_is_flow_listbox_color_w}			= $whereami->{_is_flow_listbox_color_w};
...
=cut
 ...
 sub get4superflow_select_button{
	my ($self) = @_;
	my $here;
    $here->{_is_superflow_select_button} = $whereami->{_is_superflow_select_button};
...
=cut
 ...
 sub set4add2flow_button{
    ...
    $whereami->{_is_add2flow_button} 	= $true;
    					  # print("1. whereami,set4add2flow_button, $whereami->{_is_add2flow_button}\n");
   	return();
 }
 ...
 sub set4check_code_button{
	my ($self) = @_;
    	...
    	$whereami->{_is_check_code_button} = $true;
    					   print("1. whereami,set4check_code_button, $whereami->{_is_check_code_button}\n");
   		return();
 }
