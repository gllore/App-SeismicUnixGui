...
sub numberOfBuriedSurfaces{
   ...
   if($numberOfBuriedSurfaces) {
	$unif2->{_numberOfBuriedSurfaces}	= $numberOfBuriedSurfaces;
    	$unif2->{_Step}      			= $unif2->{_Step}.' numberOfBuriedSurfaces='.$unif2->{_numberOfBuriedSurfaces} ;
    	$unif2->{_note}      			= $unif2->{_note}.' numberOfBuriedSurfaces='.$unif2->{_numberOfBuriedSurfaces} ;
   }
}
...
sub numberXGridPoints {
   ...
   if($numberXGridPoints) {
    ...
    $unif2->{_Step}       		= $unif2->{_Step}.' numberXGridPoints='.$unif2->{_numberXGridPoints} ;
    $unif2->{_note}       		= $unif2->{_note}.' numberXGridPoints='.$unif2->{_numberXGridPoints} ;
   }
}
...
sub numberZGridPoints {
   ...
   if($numberZGridPoints) {
    ...
    $unif2->{_Step}       		= $unif2->{_Step}.' numberZGridPoints='.$unif2->{_numberZGridPoints} ;
    $unif2->{_note}       		= $unif2->{_note}.' numberZGridPoints='.$unif2->{_numberZGridPoints} ;
   }
}
...
sub maxNumberGridPointsOnBuriedSurfaces {
   ...
   if($maxNumberGridPointsOnBuriedSurfaces) {
    $unif2->{_maxNumberGridPointsOnBuriedSurfaces}	= $maxNumberGridPointsOnBuriedSurfaces;
    $unif2->{_Step}       	= $unif2->{_Step}.' maxNumberGridPointsOnBuriedSurfaces='.$unif2->{_maxNumberGridPointsOnBuriedSurfaces} ;
    $unif2->{_note}       	= $unif2->{_note}.' maxNumberGridPointsOnBuriedSurfaces='.$unif2->{_maxNumberGridPointsOnBuriedSurfaces} ;
   }
}
...
sub verticalGridSpacing_m {
   ...
   if($verticalGridSpacing_m) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' verticalGridSpacing_m='.$unif2->{_verticalGridSpacing_m} ;
    $unif2->{_note}       	= $unif2->{_note}.' verticalGridSpacing_m='.$unif2->{_verticalGridSpacing_m} ;
   }
}
=head2 subroutine dz
...
sub horizontalGridSpacing_m {
   ...
   if($horizontalGridSpacing_m) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' horizontalGridSpacing_m='.$unif2->{_horizontalGridSpacing_m} ;
    $unif2->{_note}       	= $unif2->{_note}.' horizontalGridSpacing_m='.$unif2->{_horizontalGridSpacing_m} ;
   }
}
...
sub firstXvalue {
   ...
   if($firstXvalue) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' firstXvalue='.$unif2->{_firstXvalue} ;
    $unif2->{_note}       	= $unif2->{_note}.' firstXvalue='.$unif2->{_firstXvalue} ;
   }
}
...
sub firstZvalue_m {
   ...
   if($firstZvalue_m) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' firstZvalue_m='.$unif2->{_firstZvalue_m} ;
    $unif2->{_note}       	= $unif2->{_note}.' firstZvalue_m='.$unif2->{_firstZvalue_m} ;
   }
}
...
sub verticalVelocityGradient {
   ...
   if($verticalVelocityGradient) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' verticalVelocityGradient='.$unif2->{_verticalVelocityGradient} ;
    $unif2->{_note}       	= $unif2->{_note}.' verticalVelocityGradient='.$unif2->{_verticalVelocityGradient} ;
   }
}
...
sub horizontalVelocityGradient {
   ...
   if($horizontalVelocityGradient) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' horizontalVelocityGradient='.$unif2->{_horizontalVelocityGradient} ;
    $unif2->{_note}       	= $unif2->{_note}.' horizontalVelocityGradient='.$unif2->{_horizontalVelocityGradient} ;
   }
}
...
sub XVelocityList_m {
   ...
   if($XVelocityList_m) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' XVelocityList_m='.$unif2->{_XVelocityList_m} ;
    $unif2->{_note}       	= $unif2->{_note}.' XVelocityList_m='.$unif2->{_XVelocityList_m} ;
   }
}
...
sub ZVelocityList_m {
   ...
   if($ZVelocityList_m) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' ZVelocityList_m='.$unif2->{_ZVelocityList_m} ;
    $unif2->{_note}       	= $unif2->{_note}.' ZVelocityList_m='.$unif2->{_ZVelocityList_m} ;
   }
}
...
sub velocityList_mps {
   ...
   if($velocityList_mps) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' velocityList_mps='.$unif2->{_velocityList_mps} ;
    $unif2->{_note}       	= $unif2->{_note}.' velocityList_mps='.$unif2->{_velocityList_mps} ;
   }
}
...
sub interpolateBuriedSurfaceWith {
   ...
   if($interpolateBuriedSurfaceWith) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' interpolateBuriedSurfaceWith='.$unif2->{_interpolateBuriedSurfaceWith} ;
    $unif2->{_note}       	= $unif2->{_note}.' interpolateBuriedSurfaceWith='.$unif2->{_interpolateBuriedSurfaceWith} ;
   }
}
...
sub outboundTestFile {
   ...
   if($outboundTestFile) {
    ...
    $unif2->{_Step}       	= $unif2->{_Step}.' outboundTestFile='.$unif2->{_outboundTestFile} ;
    $unif2->{_note}       	= $unif2->{_note}.' outboundTestFile='.$unif2->{_outboundTestFile} ;
   }
}
