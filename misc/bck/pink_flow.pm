...
sub _set_is_last_parameter_index_touched_color {	
	...
	if ($flow_color eq 'pink') {
		...
		$color_flow->{_is_last_parameter_index_touched_color}	=  $color_flow->{_is_last_parameter_index_touched_pink};
			...
			print("color_flow,_set_is_last_parameter_index_touched_color, is_last_parameter_index_touched_pink: $color_flow->{_is_last_parameter_index_touched_pink}\n");
...
sub _set_last_parameter_index_touched_color {	
	...
	if ($flow_color eq 'pink') {
		...
		$color_flow->{_last_parameter_index_touched_color}	=  $color_flow->{_last_parameter_index_touched_pink};
			...
			print("color_flow,_set_last_parameter_index_touched_color, last_parameter_index_touched_pink: $color_flow->{_last_parameter_index_touched_pink}\n");
...
=cut
 ...
 sub flow_select { 
	...
	# program
			 ...
			 $color_flow->{_flow_color} 	  eq  'grey'		 &&  # must stay as grey--- a magic number.... TODO
