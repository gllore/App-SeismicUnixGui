...
sub _update_button {
	...
	if ( $new_most_recent_button ne $empty_string ) {
		...
		if ( $new_most_recent_button eq 'FileDialog_button' ) {
			...
			# and the selected element must have changed
			   ...
			   print("2. gui_history, _update_button, for flow_select new most_recent_index=$most_recent_index \n");
			   print("2. gui_history, _update_button, for flow_select new prior_index=$flow_select_index_href->{_prior} \n");
