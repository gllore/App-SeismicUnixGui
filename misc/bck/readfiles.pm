...
sub get_cols_8 {
	...
	if ( $readfiles->{_skip_lines} ne $empty_string  &&
		...
		open( $inbound_fh, '<', $inbound) || 
				print("readfiles,cols_8,Can't open $readfiles->{_file_name}, $!\n");
    	...
    	print ("readfiles, cols_8, The input file contains $num_rows row(s)\n\n");
		...
		# close the file of interest
 		...
 		print("readfiles,cols_8,missing either #skip_lines, path or file_name\n");
