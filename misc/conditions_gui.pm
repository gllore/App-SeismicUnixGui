...
sub _get_add2flow {
	...
	if ( $color eq 'grey' ) {
		...
		print(
			"conditions_gui,  _get_add2flow_button, missing color,missing color, color:$color\n"
		);
	}
...
sub _get_flow_color {
	...
	if ( $conditions_gui->{_flow_color} ) {
		...
		print(
			"conditions_gui,_get_flow_color  missing conditions_gui->{_flow_color}\n"
		);
...
sub _get_flow_listbox_color_w {
	...
	if ( $conditions_gui->{_flow_listbox_color_w} ) {
		...
		print(
			"conditions_gui, _get_flow_listbox_color_w, unassigned flow listbox w for current color\n"
		);
		return ();
	}
...
sub _reset_is_flow_listbox_color_w {
		...
		|| $conditions_gui->{_flow_color} eq 'neutral' )
	{
		...
		print(
			" conditions_gui, _reset_is_flow_listbox_color_w ,missing flow color \n"
		);
	}
...
sub _set_flow_listbox_color_w {
	...
	if ( $color eq 'grey' ) {
		...
		$flow_listbox_color_w = $conditions_gui->{_flow_listbox_grey_w}
		...
		$flow_listbox_color_w = $conditions_gui->{_flow_listbox_pink_w}
			;                             # for possible export via get_hash_ref
		...
		$flow_listbox_color_w = $conditions_gui->{_flow_listbox_green_w}
			;                             # for possible export via get_hash_ref
		...
		$flow_listbox_color_w = $conditions_gui->{_flow_listbox_blue_w}
			;                             # for possible export via get_hash_ref
		...
		print(
			"conditions_gui, _set_flow_listbox_color_w, missing color, color:$color\n"
		);
	}
...
sub _set_flow_listbox_last_touched_txt {
	...
	if ($last_flow_lstbx_touched) {
		$conditions_gui->{_last_flow_listbox_touched} =
...
# print("conditions_gui,_set_flow_listbox_touched left listbox = $conditions_gui->{_last_flow_listbox_touched}\n");
		...
		print(
			"conditions_gui,set_flow_listbox_touched_txt, missing listbox name\n"
		);
	}
...
# print("1 conditions_gui, _set_flow_listbox_last_touched_w; $flow_listbox_color_w\n");
		...
		print(
			"conditions_gui,_set_flow_listbox_touched_w, missing listbox widget\n"
		);
	}
	return ();
}
...
sub get_hash_ref {
	...
	if ($conditions_gui) {
		...
		$conditions_gui->{_check_buttons_settings_aref} =
...
# print("conditions_gui, get_hash_ref , conditions_gui->{_flowNsuperflow_name_w: $conditions_gui->{_flowNsuperflow_name_w}\n");
		...
		print(
			"conditions_gui, get_hash_ref , missing hconditions_gui hash_ref\n"
		);
	}
}
...
sub set4FileDialog_SaveAs_start {
	...
	if ( $conditions_gui->{_flow_type} eq $flow_type_h->{_user_built} ) {
		...
		$conditions_gui->{_flow_type} eq $flow_type_h->{_pre_built_superflow} )
	{
...
# save copies of values for reassignment during get_hash_ref call from outside modules
		...
		print(
			"conditions_gui, set4end_of_flow_item_up_arrow_button, no color: $color\n"
		);
	}
...
# print("conditions_gui, set4end_of_flow_select,is_last_flow_index_touched_grey=$is_last_flow_index_touched_grey\n");
			...
			print(
				"conditions_gui, set4end_of_flow_select , color missing: $color\n"
			);
		}
...
# print("1 conditions_gui, _get_num_listboxes_occupied: @{$conditions_gui->{_occupied_listbox_aref}} \n");
	if ( $conditions_gui->{_occupied_listbox_aref} ) {
		...
		print(
			"2 conditions_gui, get_num_listboxes_occupied: missing conditions_gui->{_occupied_listbox_aref} \n"
		);
	}
}
...
sub set4last_delete_from_flow_button {
		...
		|| $color eq 'blue' )
	{
		...
		print(
			"conditions_gui, set4last_delete_from_flow_button, color missing: $color\n"
		);
	}
	...
	if ( $color eq 'grey' ) {
		...
		print(
			"conditions_gui, set4last_delete_from_flow_buttonset, color missing: $color\n"
		);
	}
...
#   				print("conditions_gui, set4start_of_delete_from_flow_button, flow_listbox_color_w_key: $flow_listbox_color_w_key\n");
		...
		print(
			"conditions_gui, set4start_of_delete_from_flow_button, no color: $color\n"
		);
	}
...
sub set4start_of_flow_item_up_arrow_button {
	...
	if ($color) {
		...
		print(
			"conditions_gui, set4start_of_flow_item_up_arrow_button, no color: $color\n"
		);
	}
...
# print("2 conditions_gui,set4end_of_add2flow  flow_listbox_color_w: $flow_listbox_color_w\n");
		...
		if ( $conditions_gui->{_flow_color} eq 'grey' ) {
			...
			print(
				"2 conditions_gui,set4end_of_add2flow_of_run_button missing color \n"
			);
		}
...
# print("2 conditions_gui,set4end_of_add2flow_button  flow_listbox_color_w: $flow_listbox_color_w\n");
		...
		if ( $conditions_gui->{_flow_color} eq 'grey' ) {
			...
			print(
				"2 conditions_gui,set4end_of_add2flow_button_of_run_button missing color \n"
			);
		}
		...
		print(
			"2 conditions_gui,set4end_of_add2flow_button reset color: $color\n"
		);
	}
}
...
sub set_flow_index_last_touched {
	...
	if ($index) {    # if defined
		...
		if ( $index >= 0 )
		{            # -1 does exist in conditions_gui thru default definition
			$conditions_gui->{_last_flow_index_touched_grey} =
				$index;    # internal
			$conditions_gui->{_last_flow_index_touched_pink} =
				$index;    # internal
