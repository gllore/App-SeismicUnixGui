...
my @use;
$use[0] = "\t" . 'use Moose;' . "\n";
$use[1] = "\t" . 'use LSeismicUnix::misc::SeismicUnix qw ($in $out $on $go $to $suffix_ascii $off $suffix_segd $suffix_segy $suffix_sgy $suffix_su $suffix_segd $suffix_txt $suffix_bin);' . "\n";
$use[2] = "\t" . 'use LSeismicUnix::configs::big_streams::Project_config;' . "\n\n";
...
$use[8] = "\t" . 'use LSeismicUnix::misc::message;' . "\n" . "\t" . 'use LSeismicUnix::misc::flow;' . "\n";
